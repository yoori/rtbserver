...
/* $Id: KafkaProducer.cpp 185723 2019-05-13 12:00:57Z jurij_kuznecov $
...
namespace AdServer
{
  namespace Commons
  {
    namespace Kafka
    {
      ...
      void
      Producer::StatsObject::work_() throw()
      {
      ...
      void
      Producer::StatsObject::terminate_() throw()
      {
        SyncPolicy::WriteGuard lock(lock_);
