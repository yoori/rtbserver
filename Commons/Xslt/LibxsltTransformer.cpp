...
namespace AdServer
{
  ...
  public:
     ...
     */
    static void
    xslt_generic_error(void* context, const char* message, ...) throw ();
  ...
  private:
    ...
    void
    clear_thread_last_error_() throw ();
  ...
  namespace
  {
    ...
    {
      void
      operator()(const xsltTransformContextPtr context) throw ();
    };
    ...
    {
      void
      operator ()(const xmlDocPtr doc) throw ()
      {
        if(doc)
        {
          doc->URL = 0;
    ...
    {
      void
      operator ()(const xmlOutputBufferPtr buffer) throw ()
      {
  ...
  const char*
  ErrorListener::get_last_error() throw ()
  {
    pthread_t tid = pthread_self();
    const char* msg = 0;
   ...
   */
  void
  ErrorListener::clear_thread_last_error_() throw ()
  {
    if (get_last_error())
    {
      pthread_t tid = pthread_self();
  ...
  ErrorListener::ThreadGuard::~ThreadGuard() throw ()
  {
  ...
  LibxsltHolder::LibxsltHolder() throw ()
  {
    initialize_i_();
  }
  ...
  void
  LibxsltHolder::deinitialize_() throw ()
  {
    Guard lock(lock_);
  ...
  LibxslTransformer::LibxslTransformer() throw ()
  {
  }
   ...
   */
  int
  transform_result_write_close_callback(void* /*context*/) throw ()
  {
//    std::ostream& output = *static_cast<std::ostream*>(context);
//    output << std::flush;
    return 0;
