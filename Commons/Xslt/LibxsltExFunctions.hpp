...
namespace AdServer
{
  ...
  public:
    ...
    create(const char* fun_namespace, const char* fun_name) throw()
    {
     ...
     */
    static void
    execute(xmlXPathParserContextPtr context, int nargs) throw ()
    {
...
namespace AdServer
{
  ...
  inline
  XslFunctionRegistrar::XslFunctionRegistrar() throw ()
  {
  }
  ...
  template <typename Functor>
  StringConvertFunction<Functor>::~StringConvertFunction() throw ()
  {
  }
