...
namespace Commons
{
  ...
  struct TextTemplateCacheConfiguration
  {
    ...
    private:
      virtual ~TextTemplateHolder() throw() {}
    };
    ...
    unsigned long
    size(const TextTemplateHolder* val) const throw();

    Text_var
    adapt(const TextTemplateHolder* val) const throw();
...
namespace Commons
{
  ...
  TextTemplateCacheConfiguration<Text>::size(
    const TextTemplateHolder* val) const throw()
  {
    return val->size;
  }
