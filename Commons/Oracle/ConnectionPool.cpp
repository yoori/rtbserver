...
namespace Oracle
{
  ...
  bool
  ConnectionPool::add_free_connection_(Connection* conn) throw()
  {
  ...
  bool
  StandartConnectionPool::destroy_connection(Connection* conn) throw()
  {
    return !add_free_connection_(conn);
  }

  void
  StandartConnectionPool::connection_destroyed() throw()
  {
    busy_connections_ += -1;
  }
  ...
  SwitchableConnectionPool::~SwitchableConnectionPool() throw()
  {}

  void
  SwitchableConnectionPool::deactivate_object() throw()
  {
  ...
  unsigned long
  SwitchableConnectionPool::busy_connections() const throw()
  {
    return active_count();
  }
  ...
  void
  SwitchableConnectionPool::connection_destroyed() throw()
  {
    add_active_count(-1);
  }
  ...
  void
  SwitchableConnectionPool::create_connection_canceled_i_() throw()
  {
    add_active_count(-1);
  }
