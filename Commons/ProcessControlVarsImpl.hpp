...
// $Id: ProcessControlVarsImpl.hpp 126112 2013-07-23 09:13:23Z andrey_gusev $
...
struct DbStateChanger: public virtual ReferenceCounting::Interface
{
  ...
  static const char* print_db_state(bool db_state) throw();
};
...
protected:
  virtual ~ProcessControlVarsImpl() throw() {}
...
protected:
  virtual ~CommonProcessControlVarsImpl() throw() {}
};
...
protected:
   ...
   */
  virtual
  ~ProcessControlVarsLoggerImpl() throw ();
private:
...
namespace Commons {
  ...
  inline const char*
  DbStateChanger::print_db_state(bool db_state) throw()
  {
  ...
  inline
  ProcessControlVarsLoggerImpl::~ProcessControlVarsLoggerImpl() throw ()
  {}
