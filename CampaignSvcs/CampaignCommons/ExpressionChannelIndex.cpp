...
namespace CampaignSvcs
{
  ...
  namespace
  {
    ...
    private:
      virtual ~ExpressionIndexing() throw() {}
    };
    ...
    {
    private:
      virtual ~ExpressionIndexingMap() throw() {}
    };
    ...
    struct ChannelPriority
    {
      ...
      bool operator<(const ChannelPriority& right) const throw()
      {
    ...
    struct ExpressionIndexingUsePriority
    {
      ...
      bool operator<(const ExpressionIndexingUsePriority& right) const throw()
      {
    ...
    {
    private:
      virtual ~ExpressionIndexingUseMap() throw() {}
    };
  ...
  ExpressionChannelIndex::ExpressionChannelIndex() throw()
  {}
  ...
  unsigned long
  ExpressionChannelIndex::size() const throw()
  {
    return channels_.size();
  }

  unsigned long
  ExpressionChannelIndex::avg_seq_size_() const throw()
  {
    unsigned long sum = 0;
