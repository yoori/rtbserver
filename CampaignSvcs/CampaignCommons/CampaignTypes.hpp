...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    {
      bool operator==(const CampaignDeliveryLimits& right) const throw();
    ...
    {
    public:
      bool operator==(const OptionValueMap& right) const throw();
    };
    ...
    struct OptionValue
    {
      ...
      bool operator==(const OptionValue& right) const throw();
    };
...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    inline
    bool
    OptionValueMap::operator==(const OptionValueMap& right) const throw()
    {
    ...
    inline
    bool
    OptionValue::operator==(const OptionValue& right) const throw()
    {
