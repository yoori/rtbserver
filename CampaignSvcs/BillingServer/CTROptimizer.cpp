...
namespace CampaignSvcs
{
  ...
  CTROptimizer::RevenueDecimalHolder::RevenueDecimalHolder() throw()
    : RevenueDecimal(RevenueDecimal::ZERO)
  {}

  CTROptimizer::RevenueDecimalHolder&
  CTROptimizer::RevenueDecimalHolder::operator=(const RevenueDecimal& right) throw()
  {
  ...
  CTROptimizer::HourBudgetDistribution::HourBudgetDistribution() throw()
  {
    resize(24);
  ...
  CTROptimizer::HourRateDistribution::HourRateDistribution() throw()
  {
    resize(24);
    std::fill(begin(), end(), RevenueDecimal::ZERO);
  }
  ...
  CTROptimizer::HourAmount::HourAmount() throw()
  ...
  RevenueDecimal
  CTROptimizer::HourAmountDistribution::sum_amount() const throw()
  {
    RevenueDecimal res = RevenueDecimal::ZERO;
  ...
  CTROptimizer::RateAmountDistribution::swap(
    RateAmountDistribution& right) throw()
  {
