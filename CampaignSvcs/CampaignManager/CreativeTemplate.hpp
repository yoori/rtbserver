...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    {
    protected:
      virtual ~RCOptionTokenValueMap() throw() {}
    };
    ...
    public:
      ...
      struct Handler
      {
        ...
        bool operator<(const Handler& right) const throw()
        {
    ...
    public:
      ...
      bool exist(const _KEY& key) const throw();
    ...
    struct CreativeTemplateKey
    {
      CreativeTemplateKey(
        ...
        const char* app_format_val) throw();
      ...
      bool operator==(const CreativeTemplateKey& src) const /* throw() */;
    ...
    struct CreativeTemplate: public CreativeTemplateFactory::Handler
    {
      ...
      CreativeTemplate(
        ...
        const Generics::Time& ts_val) throw()
