...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    namespace
    {
      ...
      balance_function(const Creative* creative) throw ()
      {
      ...
      ctr_creative_holder_balance_function(
        const SizedCreativeHolder& creative_holder) throw ()
      {
        return creative_holder.creative->weight;
      }

      inline unsigned long
      equal_weight_fun(const CampaignSelector::WeightedCampaignPtr&) throw ()
      {
        return 1;
      }
    }
    ...
    CampaignSelector::ExpectedEcpm::ExpectedEcpm() throw ()
      : ex_ecpm_quad_sum_(ExtRevenueDecimal::ZERO),
        ex_ecpm_sum_(ExtRevenueDecimal::ZERO)
    {}

    RevenueDecimal
    CampaignSelector::ExpectedEcpm::value() const throw ()
    {
    ...
    CampaignSelector::ExpectedEcpm&
    CampaignSelector::ExpectedEcpm::operator+= (const RevenueDecimal& arg) throw ()
    {
