...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    campaign_selection_cell_less_pred(
      ...
      const CampaignSelectionCell* right) throw ();
    ...
    campaign_cell_less_pred(
      ...
      const CampaignCell* right) throw ();
    ...
    {
    public:
      CampaignSelectionCellList() throw ();
    ...
    public:
      ...
      void
      trace_tree(std::ostream& ostr) throw();
    ...
    private:
      ...
      struct KeyHashAdapter
      {
        ...
        bool operator==(const KeyHashAdapter& right) const throw();
    ...
    private:
      ...
      decode_match_status_type_(
        unsigned char match_status_type) throw();
...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    inline
    CampaignSelectionCell::~CampaignSelectionCell() throw()
    {}
    ...
    // CampaignSelectionCellList
    inline
    CampaignSelectionCellList::CampaignSelectionCellList() throw ()
    {}
    ...
    inline
    CampaignCell::~CampaignCell() throw()
    {}
    ...
    // CampaignCellList
    inline
    CampaignCellList::CampaignCellList() throw ()
    {}
    ...
    inline
    unsigned long
    CampaignIndex::size() const throw()
    {
    ...
    CampaignIndex::KeyHashAdapter::operator==(
      const KeyHashAdapter& right) const throw()
    {
    ...
    inline
    unsigned long
    CampaignIndex::KeyHashAdapter::hash() const throw()
    {
      return hash_;
    }
