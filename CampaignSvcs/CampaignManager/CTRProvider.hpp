...
namespace CampaignSvcs
{
  ...
  */
  ...
  protected:
    ...
    public:
      Model(unsigned long model_id) throw();
  ...
  public:
    ...
    protected:
      virtual ~CalculationContext() throw();
  ...
  protected:
    ...
    static FeatureType
    feature_type_(const Feature& feature) throw();
