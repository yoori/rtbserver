...
#       undef F2C
  ...
  {
  protected:
    virtual ~FastFeatureSetHolder() throw()
    {}
  };
  ...
  namespace
  {
    ...
    protected:
      virtual ~FeatureSetProvider_() throw()
      {}
  ...
  {
    // FeatureNameResolver
    FeatureNameResolver::FeatureNameResolver() throw()
    {}
  ...
  public:
    ...
    protected:
      virtual
      ~ConfigDescriptor() throw () = default;
    };
  ...
  protected:
    ...
    protected:
      virtual
      ~JsonBasicFeatureProcessor() throw () = default;
    };
    ...
    protected:
      virtual
      ~JsonFeatureArrayProcessor() throw () = default;
    };
    ...
    {
      result_type
      operator() (argument_type config_descriptor) const throw()
      {
    ...
    {
      result_type
      operator()(argument_type alg_descriptor) const throw()
      {
  ...
  protected:
    virtual
    ~RemoveConfigTask() throw() = default;
  ...
  void
  RemoveConfigTask::execute() throw()
  {
  ...
  // ConfigParser
  CTRProvider::ConfigParser::ConfigParser() throw()
  {
  ...
  // CTRProvider::AlgsRef
  void
  CTRProvider::AlgsRef::print(std::ostream& out) const throw()
  {
  ...
  CTRProvider::Calculation::~Calculation() throw()
  {}
  ...
  */
    ...
    throw(Overflow)
  {
    ...
    {
      xgboost_predictor = model_predictor_it->second.in();
    }
    else
    {
      assert(model.xgboost_predictor_pool.in());
      ...
      xgboost_predictor = new_xgboost_predictor.in();
    }
      ...
      if(alg_it->weight > 0)
      {
            ...
            model_it != alg_it->models.end(); ++model_it)
        {
          ...
          else if(model->method == MM_XGBOOST)
          {
            ...
            try
            {
              model->xgboost_predictor_pool = new CTR::XGBoostPredictorPool(
                model_file);
            }
