  ...
  namespace AdInstances
  {
    ...
    struct AppFormatDef
    {
      ...
      AppFormatDef(
        ...
        const Timestamp& timestamp_val) throw()
    ...
    public:
      ...
      bool cost_is_gross() const throw()
      {
      ...
      bool agency_profit_by_pub_amount() const throw()
      {
      ...
      RevenueDecimal
      get_self_service_commission() const throw()
      {
      ...
      adapt_cost(
        ...
        const RevenueDecimal& ccg_commision) const throw()
      {
      ...
      RevenueDecimal revert_cost(
        const RevenueDecimal& cost,
        const RevenueDecimal& commision) const throw()
      {
        RevenueDecimal res_cost = cost;
      ...
      bool
      is_available() const throw();

      unsigned long
      bill_account_id() const throw()
      {
        return use_self_budget() ? account_id : agency_account->account_id;
      }

      unsigned long
      not_bill_account_id() const throw()
      {
        if(use_self_budget())
        {
      ...
      void
      set_available(bool available_val) const throw();
    ...
    public:
      bool site_exclusion() const throw()
      {
        return account->at_flags & SITE_EXCLUSION_FLAG;
      }

      bool tag_exclusion() const throw()
      {
    ...
    public:
      ...
      bool targeted() const throw();

      bool track_actions() const throw();

      bool exclude_clickurl() const throw();

      bool include_specific_sites() const throw();

      bool is_test() const throw();

      bool channel_based() const throw();

      bool keyword_based() const throw();

      bool is_text() const throw();

      bool use_ctr() const throw()
      {
      ...
      void add_creative(Creative* new_creative) throw();

      const CreativeList& get_creatives() const throw();
      ...
      unsigned long
      int_min_ctr_goal() const throw();

      RevenueDecimal
      min_ctr_goal() const throw();
    ...
    protected:
      virtual
      ~CategoryChannelNode() throw () = default;
    };
    ...
    protected:
      virtual
      ~SimpleChannelCategories() throw () = default;
    };
    ...
    struct PubPixelAccountKey
    {
      ...
      bool
      operator==(const PubPixelAccountKey& right) const throw()
      {
    ...
    {
      WebOperationKey() throw(){};

      WebOperationKey(
        const char* app_val,
        const char* source_val,
        const char* operation_val) throw()
        : app(app_val),
          source(source_val),
      ...
      bool
      operator==(const WebOperationKey& right) const throw()
      {
...
namespace CampaignSvcs
{
  namespace AdInstances
  {
    ...
    // AccountDef impl
    inline bool
    AccountDef::is_available() const throw()
    {
      return available_;
    }

    inline void
    AccountDef::set_available(bool available_val) const throw()
    {
    ...
    inline
    bool Campaign::targeted() const throw()
    {
      return channel.in();
    }

    inline
    bool Campaign::track_actions() const throw()
    {
      return (flags & CampaignFlags::TRACK_ACTIONS) ? true : false;
    }

    inline
    bool Campaign::include_specific_sites() const throw()
    {
      return (flags & CampaignFlags::INCLUDE_SPECIFIC_SITES) ? true : false;
    }

    inline
    bool Campaign::is_test() const throw()
    {
      return (account->flags & AccountFlags::TEST) ? true : false;
    }

    inline
    bool Campaign::channel_based() const throw()
    {
      return targeting_type == 'C';
    }

    inline
    bool Campaign::keyword_based() const throw()
    {
      return targeting_type == 'K';
    }

    inline
    bool Campaign::is_text() const throw()
    {
      return ccg_type == CT_TEXT;
    }

    inline bool
    Campaign::is_available() const throw()
    {
      /*
    ...
    inline
    void Campaign::add_creative(Creative* new_creative) throw()
    {
    ...
    inline
    const CreativeList&
    Campaign::get_creatives() const throw()
    {
      return creatives;
    }
    ...
    Campaign::int_min_ctr_goal() const throw()
    {
      return int_min_ctr_goal_;
    }

    inline RevenueDecimal
    Campaign::min_ctr_goal() const throw()
    {
      return RevenueDecimal::div(
