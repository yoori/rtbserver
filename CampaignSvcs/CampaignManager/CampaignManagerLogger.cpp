...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    {
    public:
      result_type operator() (const argument_type& in) const throw()
      {
        result_type ret;
    ...
    protected:
      virtual
      ~ChannelTriggerStatLogger() throw () = default;
    ...
    protected:
      virtual
      ~ChannelHitStatLogger() throw () = default;
    ...
    protected:
      virtual
      ~UserPropertiesLogger() throw () = default;
    ...
    protected:
      virtual
      ~RequestBasicChannelsLogger() throw () = default;
    ...
    protected:
      virtual
      ~ResearchWebStatLogger() throw () = default;
    };
    ...
    protected:
      virtual
      ~CreativeStatLogger() throw () = default;
    ...
    protected:
      virtual
      ~ImpressionLogger() throw () = default;
    };
    ...
    protected:
      virtual
      ~AdvertiserActionLogger() throw () = default;
    };
    ...
    protected:
      virtual
      ~ActionRequestLogger() throw () = default;
    };
    ...
    protected:
      virtual
      ~PassbackImpressionLogger() throw () = default;
    };
    ...
    protected:
      virtual
      ~PassbackStatLogger() throw () = default;
    };
    ...
    protected:
      virtual
      ~TagRequestLogger() throw () = default;
    ...
    protected:
      virtual
      ~TagPositionStatLogger() throw () = default;
    ...
    private:
      virtual
      ~SearchTermStatLogger() throw () = default;
    ...
    private:
      virtual
      ~SearchEngineStatLogger() throw () = default;
    ...
    protected:
      virtual
      ~TagAuctionStatLogger() throw () = default;
    ...
    protected:
      virtual
      ~UserAgentStatLogger() throw () = default;
    ...
    protected:
      ...
      virtual
      ~ProfilingResearchLogger() throw () = default;
    };
    ...
    CampaignManagerLogger::~CampaignManagerLogger() throw()
    {}
