...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    private:
      ...
      static void
      fill_tag_pricings_(Tag* tag) throw();
      ...
      void fill_platform_channel_priorities_(
        CampaignConfig& new_config,
        const ConfigUpdateLinks& config_update_links) throw();
      ...
      void check_category_channels_(CampaignConfig& new_config) throw();

      void fill_campaign_action_markers_(CampaignConfig& new_config) throw();

      void enrich_channels_by_geo_channels_(CampaignConfig& new_config) throw();

      void
      enrich_channels_by_geo_coord_channels_(
        CampaignConfig& new_config) throw();

      void enrich_channels_by_platform_channels_(CampaignConfig& new_config) throw();
      ...
      void preinstantiate_creative_tokens_(CampaignConfig& new_config) throw();
