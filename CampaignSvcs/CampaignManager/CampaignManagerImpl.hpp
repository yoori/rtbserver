...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    private:
      ...
      protected:
        virtual
        ~CampaignManagerTaskMessage() throw () = default;
    ...
    private:
      ...
      // task methods
      void check_config() throw();

      void update_ctr_provider() throw();

      void update_conv_rate_provider() throw();

      void flush_logs() throw();
      ...
      update_rate_provider_(
        const CTRProvider* old_ctr_provider,
...
namespace CampaignSvcs
{
  ...
  inline
  void CampaignManagerImpl::FlushLogsTaskMessage::execute() throw()
  {
    manager_->flush_logs();
  }
  ...
  inline
  void
  CampaignManagerImpl::CheckConfigTaskMessage::execute() throw()
  {
  ...
  inline
  void
  CampaignManagerImpl::UpdateCTRProviderTask::execute() throw()
  {
  ...
  inline
  void
  CampaignManagerImpl::UpdateConvRateProviderTask::execute() throw()
  {
