...
namespace
{
  ...
  match(
    ...
    AdServer::CampaignSvcs::UserStatus st) throw ()
  {
    using namespace AdServer::CampaignSvcs;
...
namespace AdServer
{
  namespace CampaignSvcs
  {
      ...
      throw (Exception, eh::Exception)
    {
      ...
      {
        trace_params.trace_stream <<
          "  <step name=\"channel targeting\" passed=\"yes\"/>" <<
          std::endl;
      }
      else
      {
        trace_params.trace_stream <<
          "  <step name=\"channel targeting\" passed=\"no\"/>" <<
          std::endl;
      }
    ...
    void print_campaign_cell_list_(
      std::ostream& ostr,
      const CampaignCellList* campaign_cell_list) throw()
    {
    ...
    void
    CampaignIndex::trace_tree(std::ostream& ostr) throw()
    {
      const char OFFSET[] = "  ";
