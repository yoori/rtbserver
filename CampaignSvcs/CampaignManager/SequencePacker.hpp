  ...
  namespace CampaignSvcs
  {
    ...
    public:
      ...
      ConstElementSeq_var create_seq(
        const ElementSeqType* el_seq, const ElementType* el) throw();

      unsigned long ptrs_size_() const throw();
      
      unsigned long size_() const throw();

      unsigned long hashes_count_() const throw();
