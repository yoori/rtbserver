...
namespace CampaignSvcs
{
  ...
  public:
    ...
    {
      virtual void
      set_available(bool available_val) const throw() = 0;
    };
  ...
  protected:
    virtual
    ~BillingStateContainer() throw() = default;
...
{
  inline
  void BillingStateContainer::clear_cache() throw()
  {
