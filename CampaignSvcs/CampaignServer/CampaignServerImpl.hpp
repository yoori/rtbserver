...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    protected:
      ...
      protected:
        virtual
        ~UpdateConfigTaskMessage() throw () = default;
      ...
      protected:
        virtual
        ~UpdateBillStatTask() throw () = default;
    ...
    protected:
      virtual void report_error(
        ...
        const char* description, const char* error_code = 0) throw();

      CampaignConfig_var campaign_config() throw(eh::Exception);

      virtual CampaignConfigSource_var
      get_campaign_config_source() throw() = 0;

      virtual BillStatSource_var
      get_bill_stat_source() throw() = 0;

      // tasks
      void update_bill_stat_() throw();
    ...
    protected:
      virtual
      ~CampaignServerImpl() throw ();

      virtual CampaignConfigSource_var
      get_campaign_config_source() throw();

      virtual BillStatSource_var
      get_bill_stat_source() throw();
...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    inline
    void
    CampaignServerBaseImpl::FlushLogsTask::execute() throw()
    {
      server_->flush_logs_();
    }
    ...
    inline
    void
    CampaignServerBaseImpl::UpdateConfigTaskMessage::execute() throw()
    {
    ...
    inline
    void
    CampaignServerBaseImpl::UpdateBillStatTask::execute() throw()
    {
