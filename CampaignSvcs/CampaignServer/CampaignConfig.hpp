...
namespace AdServer
{
  namespace CampaignSvcs
  {
    ...
    {
    public:
      bool operator==(const SizeDef& right) const throw();
    ...
    struct CountryDef:
       public ReferenceCounting::AtomicImpl
    {
      bool operator==(const CountryDef& right) const throw();
    ...
    {
    public:
      bool operator==(const WebOperationDef& right) const throw();
    ...
    {
    public:
      bool operator==(const StringDictionaryDef& right) const throw();

      Generics::Time timestamp;

    protected:
      virtual
      ~StringDictionaryDef() throw ()
      {
      }
    };
    ...
    struct AppFormatDef: public ReferenceCounting::AtomicImpl
    {
      ...
      bool operator==(const AppFormatDef& right) const throw();

    protected:
      virtual ~AppFormatDef() throw() 
      {}
    };
    ...
    public:
      ...
      bool operator==(const CreativeOptionDef& right) const throw();
    ...
    public:
      struct Size
      {
        ...
        bool operator==(const Size& right) const throw()
        {
      ...
      struct SystemOptions
      {
        ...
        bool operator==(const SystemOptions& right) const throw();
      ...
      bool operator==(const CreativeDef& right) const throw();
    ...
    public:
      ...
      bool operator==(const CampaignDef& right) const throw();

      char get_status() const throw()
      {
        if(status == 'I')
        {
          return 'I';
      ...
      bool creative_optimization() const throw()
      {
    ...
    public:
      ...
      bool operator==(const EcpmDef& right) const throw()
      {
    ...
    {
      bool operator==(const TagPricingDef& right) const throw();
    ...
    public:
      bool operator==(const TagDef& right) const throw();
    ...
    {
    public:
      bool operator==(const SiteDef& right) const throw();
    ...
    public:
      AccountDef() throw(): eval_status('A') {}

      bool operator==(const AccountDef& right) const throw();
      ...
      bool is_gross() const throw()
      {
        return at_flags & AccountTypeFlags::GROSS;
      }

      bool invoice_commision() const throw()
      {
        return at_flags & AccountTypeFlags::INVOICE_COMMISION;
      }

      bool is_test() const throw()
      {
        return flags & AccountFlags::TEST;
      }

      bool use_self_budget() const throw()
      {
        return at_flags & AccountTypeFlags::USE_SELF_BUDGET;
      }

      bool is_advertiser() const throw()
      {
        return role_id == 1;
      }

      bool is_agency() const throw()
      {
        return role_id == 4;
      }
    ...
    {
    public:
      bool operator==(const CurrencyDef& right) const throw();
    ...
    public:
      ...
      bool operator==(const ColocationDef& right) const throw();
    ...
    public:
      ...
      FreqCapDef(
        ...
        const TimestampValue& ts_val) throw ();

      bool operator==(const FreqCapDef& cp) const throw();
    ...
    struct CreativeTemplateFileDef
    {
      ...
      bool operator==(const CreativeTemplateFileDef& right) const throw();
    ...
    {
    public:
      bool operator==(const CreativeTemplateDef& right) const throw();
    ...
    public:
      ...
      bool operator==(const CampaignKeyword& right) const throw();
    ...
    public:
      ...
      bool operator==(const CategoryChannelDef& right) const throw();
    ...
    public:
      ...
      bool operator==(const CreativeCategoryDef& right) const throw();
    ...
    public:
      ...
      bool operator==(const AdvActionDef& right) const throw()
      {
    ...
    {
    public:
      bool operator==(const FraudConditionDef& right) const throw();
    ...
    public:
      ...
      bool operator==(const MarginRuleDef& right) const throw();
    ...
    private:
      void init_default_conditions_() throw();

      static bool account_set_eq_(
        const AccountIdSet& left, const AccountIdSet& right) throw();

      static bool pricerange_set_eq_(
        const PriceRangeSet& left, const PriceRangeSet& right) throw();
    };
    ...
    {
      bool operator==(const BehavioralParameterDef& in) const throw();
    ...
    public:
      ...
      BehavioralParameterListDef() throw();

      bool operator==(const BehavioralParameterListDef& in) const throw();
    ...
    public:
      ...
      bool operator==(const SimpleChannelDef& right) const throw();
    ...
    public:
      struct GeoIPTarget
      {
        ...
        bool operator==(const GeoIPTarget& right) const throw();
      };

      typedef std::vector<GeoIPTarget> GeoIPTargetList;

      bool operator==(const GeoChannelDef& right) const throw();
    ...
    {
    public:
      bool operator==(const GeoCoordChannelDef& right) const throw();
    ...
    public:
      bool
      operator==(const BlockChannelDef& right) const throw();
    ...
    {
      bool operator==(const SearchEngineRegExp& cp) const throw();
    ...
    public:
      ...
      bool operator==(const SearchEngine& cp) const throw();
    ...
    public:
      struct Detector
      {
        bool operator==(const Detector& cp) const throw();
      ...
      bool operator==(const WebBrowser& cp) const throw();
    ...
    public:
      ...
      bool operator==(const Platform& cp) const throw();
...
namespace AdServer
{
  ...
  {
    inline
    bool CurrencyDef::operator==(const CurrencyDef& right) const throw()
    {
    ...
    inline
    bool SiteDef::operator==(const SiteDef& right) const throw()
    {
    ...
    inline
    bool AccountDef::operator==(const AccountDef& right) const throw()
    {
    ...
    inline
    bool CampaignKeyword::operator==(const CampaignKeyword& right) const throw()
    {
    ...
    inline
    bool
    TagPricingDef::operator==(const TagPricingDef& right) const throw()
    {
    ...
    inline
    bool
    TagDef::operator==(const TagDef& right) const throw()
    {
    ...
    AppFormatDef::operator==(
      const AppFormatDef& right) const throw()
    {
    ...
    CreativeOptionDef::CreativeOptionDef(
      ...
      char type_val,
      const StringSet& token_relations_val,
      const Generics::Time& timestamp_val) throw()
      : token(token_val),
        type(type_val),
    ...
    bool CreativeOptionDef::operator==(
      const CreativeOptionDef& right) const throw()
    {
    ...
    inline
    CreativeDef::SystemOptions::SystemOptions() throw()
    ...
    inline
    bool ColocationDef::operator==(const ColocationDef& right) const throw()
    {
    ...
    inline
    bool
    FreqCapDef::operator==(const FreqCapDef& cp) const throw()
    {
    ...
    CreativeTemplateFileDef::operator==(
      const CreativeTemplateFileDef& right) const throw()
    {
    ...
    CreativeTemplateDef::operator==(
      const CreativeTemplateDef& right) const throw()
    {
    ...
    inline
    MarginRuleDef::MarginRuleDef() throw()
      : margin_rule_id(0),
        account_id(0),
        type(MR_STOP),
        sort_order(0),
    ...
    inline
    void MarginRuleDef::init_default_conditions_() throw()
    {
      user_status = '-';
      walled_garden = '-';
    ...
    inline
    bool MarginRuleDef::operator==(const MarginRuleDef& right) const throw()
    {
    ...
    bool BehavioralParameterDef::operator==(
      const BehavioralParameterDef& in) const throw()
    {
    ...
    bool BehavioralParameterListDef::operator==(
      const BehavioralParameterListDef& in) const throw()
    {
    ...
    inline
    BehavioralParameterListDef::BehavioralParameterListDef() throw()
      : threshold(0)
    {}
    ...
    bool CategoryChannelDef::operator==(
      const CategoryChannelDef& right) const throw()
    {
    ...
    CreativeDef::SystemOptions::operator==(
      const CreativeDef::SystemOptions& right) const throw()
    {
    ...
    inline
    bool CreativeDef::operator==(const CreativeDef& right) const throw()
    {
    ...
    inline
    bool CampaignDef::operator==(const CampaignDef& right) const throw()
    {
    ...
    bool FraudConditionDef::operator==(
      const FraudConditionDef& right) const throw()
    {
      return id == right.id &&
        type == right.type &&
        limit == right.limit &&
    ...
    inline bool
    BlockChannelDef::operator==(const BlockChannelDef& right) const throw()
    {
      return size_id == right.size_id;
    }

    inline
    bool SearchEngine::operator==(const SearchEngine& cp) const throw()
    {
    ...
    inline
    bool WebBrowser::operator==(const WebBrowser& right) const throw()
    {
    ...
    inline
    bool WebBrowser::Detector::operator==(const WebBrowser::Detector& right) const throw()
    {
    ...
    inline
    bool Platform::operator==(const Platform& right) const throw()
    {
    ...
    inline
    bool Platform::Detector::operator==(const Platform::Detector& right) const throw()
    {
      return priority == right.priority &&
    ...
    CreativeCategoryDef::operator==(
      const CreativeCategoryDef& right) const throw()
    {
    ...
    inline
    bool
    StringDictionaryDef::operator==(const StringDictionaryDef& right) const throw()
    {
    ...
    inline
    bool
    SizeDef::operator==(const SizeDef& right) const throw()
    {
    ...
    inline
    bool
    CountryDef::operator==(const CountryDef& right) const throw()
    {
    ...
    inline
    bool
    WebOperationDef::operator==(const WebOperationDef& right) const throw()
    {
    ...
    inline
    CampaignConfig::~CampaignConfig() throw()
    {}
  }
}
