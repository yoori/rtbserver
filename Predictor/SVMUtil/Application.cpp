  ...
  unsigned long min_occur_coef)
{
  ...
  */
  ...
  // fill skip_features
  TreeLearner<BoolLabel, PredictedLogLossGain>::FeatureIdArray all_features;
  TreeLearner<BoolLabel, PredictedLogLossGain>::FeatureRowsMap feature_rows;

  TreeLearner<BoolLabel,  PredictedLogLossGain>::fill_feature_rows(
    all_features,
    feature_rows,
    *svm);
