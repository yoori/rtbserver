...
namespace AdServer
{
  namespace Controlling
  {
    ...
    StatsCollectorAgent::~StatsCollectorAgent() throw ()
    {
    }
    ...
    double ValuesHandler::string_to_double_(const char* str) throw()
    {
      double ret;
    ...
    Generics::Time ValuesHandler::double_to_time_(double val) throw()
    {
    ...
    void ValuesHandler::finish(std::ostream& err) throw()
    {
