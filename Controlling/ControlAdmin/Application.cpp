...
namespace AdServer
{
  namespace Controlling
  {
    ...
    void ControlAdmin::print_header_() throw()
    {
      if(quiet_)
      {
        return;
    ...
    void ControlAdmin::parse_options_(int argc, char* argv[]) throw()
    {
    ...
    void ControlAdmin::help(int topic) throw()
    {
      if(topic>MAX_TOPIC)
      {
        topic = MAX_TOPIC;
    ...
    int ControlAdmin::get(int argc, char* argv[]) throw()
    {
      try
      {
    ...
    int ControlAdmin::put(int argc, char* argv[]) throw()
    {
      try
      {
        parse_options_(argc, argv);
    ...
    int ControlAdmin::run(int argc, char* argv[]) throw()
    {
      if(argc > 1)
      {
        command_ = argv[1];
