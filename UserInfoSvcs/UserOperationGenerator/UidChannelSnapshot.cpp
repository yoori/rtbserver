...
namespace UserInfoSvcs
{
  namespace
  {
    ...
    inline
    bool
    is_active(Generics::ActiveObject* interruptor) throw ()
    {
  ...
  unsigned long
  UidChannelFile::channel_id() const throw ()
  {
    return channel_id_;
  }

  const std::string&
  UidChannelFile::name() const throw ()
  {
    return name_;
  }

  const std::string&
  UidChannelFile::full_path() const throw ()
  {
    return full_path_;
  }

  const Generics::Time&
  UidChannelFile::timestamp() const throw ()
  {
    return timestamp_;
  }

  std::size_t
  UidChannelFile::count() const throw ()
  {
    std::size_t c = 0;
  ...
  std::size_t
  UidChannelSnapshot::size() const throw ()
  {
    return files_.size();
  }
}
