...
namespace UserInfoSvcs{
  ...
  UserInfoExchangePool::
  ProviderStorage::~ProviderStorage() throw()
  {}
  ...
  void
  UserInfoExchangePool::
  ProviderStorage::erase_(const char* user_id) throw()
  {
  ...
  UserInfoExchangePool::
  Customer::Customer(const char* customer_id) throw()
    : customer_id_(customer_id)
  {}

  UserInfoExchangePool::Customer::~Customer() throw()
  {}
  ...
  UserInfoExchangePool::Provider::~Provider() throw()
  {
  }
  ...
  UserInfoExchangePool::~UserInfoExchangePool() throw()
  {
  }
