...
namespace AdServer
{
  namespace UserInfoSvcs
  {
    ...
    struct UniqueChannelsResult
    {
      ...
      bool operator!=(const UniqueChannelsResult& right) const throw()
      {
        return
    ...
    public:
      ...
      ChannelsMatcher(
        ...
        Generics::SmartMemBuf* add_profile) throw();
      ...
      static void copy_history_section(
        WriterType& ciw, const ReaderType& cir) throw()
      {
        std::copy(
          cir.begin(), cir.end(),
    ...
    private:
      ...
      void add_channel_visit_(
        ...
        const ChannelsHashMap& channels,
        ChannelsInfoWriter& ciw,
        ChannelMatchMap& result_channels) throw();
