...
namespace
{
  ...
  typedef std::list<SimpleChannelProperties,
                    AdServer::UserInfoSvcs::ThreadPoolAlloc>
...
namespace UserInfoSvcs
{
   ...
   */
  UserInfoManagerImpl::
  LoadingProgressProcessor::LoadingProgressProcessor(double range) throw()
   : range_(range),
     progress_(0.0)
  {}
  ...
  void
  UserInfoManagerImpl::
  LoadingProgressProcessor::post_progress(double value) throw()
  {
  ...
  std::string
  UserInfoManagerImpl::
  LoadingProgressProcessor::get_progress_in_percents() throw()
  {
  ...
  CORBA::Boolean
  UserInfoManagerImpl::uim_ready() throw()
  {
  ...
  char*
  UserInfoManagerImpl::get_progress() throw()
  {
  ...
  void UserInfoManagerImpl::flush_logs_() throw()
  {
  ...
  void
  UserInfoManagerImpl::delete_old_profiles_(bool reschedule) throw()
  {
  ...
  void
  UserInfoManagerImpl::delete_old_temporary_profiles_(bool reschedule) throw()
  {
  ...
  void
  UserInfoManagerImpl::load_chunk_files_() throw()
  {
