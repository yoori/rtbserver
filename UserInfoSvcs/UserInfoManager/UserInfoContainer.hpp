...
namespace AdServer
{
  namespace UserInfoSvcs
  {
    ...
    public:
      ...
      protected:
        virtual ~AllUsersProcessingState() throw() {}
      };
    ...
    public:
      ...
      bool dispose_user(const UserId& user_id) throw();
      ...
      ChannelDictionary_var channels_config() const throw();

      Generics::Time time_offset() const throw();
      Generics::Time master_stamp() const throw();
    ...
    protected:
      virtual ~UserInfoContainer() throw() {};
...
namespace UserInfoSvcs
{
  ...
  inline
  Generics::Time
  UserInfoContainer::time_offset() const throw()
  {
    SyncPolicy::ReadGuard lock(config_lock_);
    return time_offset_;
  }
  ...
  inline
  Generics::Time
  UserInfoContainer::master_stamp() const throw()
  {
    SyncPolicy::ReadGuard lock(config_lock_);
