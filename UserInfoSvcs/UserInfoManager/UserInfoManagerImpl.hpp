...
namespace AdServer
{
  namespace UserInfoSvcs
  {
    ...
    protected:
      ...
      {
      public:
        LoadingProgressProcessor(double range) throw();
        virtual void post_progress(double value) throw();
        std::string get_progress_in_percents() throw();
    ...
    protected:
      virtual ~UserInfoManagerImpl() throw() {};
      ...
      void load_chunk_files_() throw();

      void update_config_() throw();

      void rotate_user_operations_backup_() throw();

      void load_user_operations_() throw();

      void delete_old_profiles_(bool reschedule) throw();
      
      void delete_old_temporary_profiles_(bool reschedule) throw();

      void get_last_colo_profiles_() throw();
...
namespace AdServer
{
  namespace UserInfoSvcs
  {
    ...
    inline
    void
    UserInfoManagerImpl::AllUsersProcessingTask::execute() throw()
    {
    ...
    inline
    Logging::Logger*
    UserInfoManagerImpl::logger() throw()
    {
      return logger_;
    }
