...
namespace UserInfoSvcs{
  ...
  UserInfoManagerControllerImpl::~UserInfoManagerControllerImpl() throw()
  {}
  ...
  UserInfoManagerControllerImpl::get_stats() throw()
  {
  ...
  UserInfoManagerControllerImpl::get_status() throw()
  {
    try
    {
      UserInfoManagersConfig_var user_info_managers_config;
  ...
  UserInfoManagerControllerImpl:: get_user_info_cluster_control_() throw()
  {
    UserInfoManagersConfig_var user_info_managers_config;
    {
      ReadGuard_ lock(lock_);
  ...
  UserInfoClusterImpl::UserInfoClusterImpl(
    UserInfoManagerControllerImpl* controller) throw()
      :
      uimc_(ReferenceCounting::add_ref(controller))
  {}

  UserInfoClusterImpl::~UserInfoClusterImpl() throw()
  {}

  CORBACommons::IProcessControl::ALIVE_STATUS
  UserInfoClusterImpl::is_alive() throw()
  {
  ...
  UserInfoClusterStatsImpl::~UserInfoClusterStatsImpl() throw()
  {}

  CORBACommons::StatsValueSeq*
  UserInfoClusterStatsImpl::get_stats() throw()
  {
