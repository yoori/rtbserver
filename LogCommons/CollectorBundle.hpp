...
private:
  ...
  static std::size_t
  add_size_(std::size_t result, const ValueT& value) throw ()
  {
  ...
  public:
     ...
     */
    virtual void
    dump_portion(const Spillover_var& data) throw () = 0;
     ...
     */
    virtual void
    dump_start(const Spillover_var& data, BundleType* spillovers_owner = 0) throw () = 0;
  protected:
    virtual
    ~ThreadLogSaver() throw ()
    {}
  };
...
public:
  ...
  bool
  file_list_is_empty() const throw ();
...
inline
bool
CollectorBundle<LogTraits>::file_list_is_empty() const throw ()
{
