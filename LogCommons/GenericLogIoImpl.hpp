...
namespace Detail
{
  ...
  {
    CollectorLoad(CollectorType& collector) throw ()
...
private:
  ...
  virtual
  ~HitsFilteringLogLoaderImpl() throw() {}
...
private:
  ...
  {
    PreviousVersionSupportAdder_(ThisType* ptr) throw ()
      : owner_(ptr)
    {}
