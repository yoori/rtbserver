...
public:
  ...
  const OptionalUlong& full_referer_hash() const throw()
  {
...
public:
  ...
  TagRequestData(TagRequestData&& init) throw()
    : time_(init.time_),
