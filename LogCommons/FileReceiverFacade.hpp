...
namespace AdServer
{
  namespace LogProcessing
  {
    namespace
    {
      ...
      {
      public:
        Timeout(unsigned long timeout) throw ()
        {
          if (!timeout)
          {
    ...
    private:
      ...
      public:
        ...
        virtual void
        on_top_changed(const std::string& new_top) throw ();

      protected:
        virtual
        ~FileReceiverHolder() throw ()
        {}
      };
