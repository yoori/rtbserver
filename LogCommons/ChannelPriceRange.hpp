...
public:
  ...
  ChannelPriceRangeInnerData() throw()
  :
    unique_users_count_(),
    impops_()
  {
  ...
  bool
  operator==(const ChannelPriceRangeInnerData& rhs) const throw()
  {
  ...
  ChannelPriceRangeInnerData&
  operator+=(const ChannelPriceRangeInnerData& rhs) throw()
  {
  ...
  Double
  unique_users_count() const throw()
  {
