...
<xsl:template name="AdFrontendConfigGenerator">
  ...
  <cfg:CommonFeConfiguration user_agent_filter_path="user_agent_filter.txt"
    ...
    <cfg:OptOutRemoveCookies>
      <cfg:Cookie name="MARef"/>
      <cfg:Cookie name="MARKw"/>
      <cfg:Cookie name="MASKw"/>
      <cfg:Cookie name="MARKww"/>
      <cfg:Cookie name="MASKww"/>

      <cfg:Cookie name="sizenotsup"/>
      <cfg:Cookie name="ct.pswnd"/>
      ...
      <cfg:Cookie name="action_info"/>
      <cfg:Cookie name="action_info2"/>
      <cfg:Cookie name="v_freq_caps"/>
      ...
      <cfg:Cookie name="sc"/>
      <cfg:Cookie name="vfc"/>
      <cfg:Cookie name="ucfc"/>
      <cfg:Cookie name="lc"/>
      <cfg:Cookie name="uid"/>
      <cfg:Cookie name="trialoptin"/>
      <cfg:Cookie name="oi_prompt"/>
  ...
  <cfg:UserBindFeConfiguration enable_profiling="false">
    <xsl:attribute name="set_uid">
    ...
    <xsl:for-each select="$colo-config/cfg:coloParams/cfg:RTB/cfg:source">
       <xsl:if test="count(cfg:userBind) > 0"> 
         <cfg:Source id="{@id}" passback="{cfg:userBind/@passback}">
           <xsl:attribute name="redirect"><xsl:value-of select="cfg:userBind/@redirect"/></xsl:attribute>

           <xsl:for-each select="cfg:userBind/cfg:keywordRedirect">
             <cfg:KeywordRedirect redirect="{@redirect}"
               keywords="{@keywords}"
               passback="{@passback}"/>
           </xsl:for-each>
        </cfg:Source>
