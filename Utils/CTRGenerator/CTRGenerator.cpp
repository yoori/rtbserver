...
#   define DEFINE_FEATURE_VALUE_FUN(NAME) \
    ...
    protected:
      virtual ~FeatureHashCalculatorFinalImpl() throw()
      {}
    ...
    protected:
      virtual ~FeatureHashCalculatorDelegateImpl() throw()
      {}
    ...
    protected:
      virtual ~FeatureHashCalculatorIdSetFinalImpl() throw()
      {}
    ...
    protected:
      virtual ~FeatureHashCalculatorIdSetDelegateImpl() throw()
      {}
    ...
    protected:
      virtual ~FeatureHashCalculatorAfterIntFinalImpl() throw()
      {}
    ...
    protected:
      virtual ~FeatureHashCalculatorAfterIntDelegateImpl() throw()
      {}
