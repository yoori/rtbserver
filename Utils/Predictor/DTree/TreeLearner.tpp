...
namespace Vanga
{
  ...
  template<typename LearnerType>
  void
  GetBestFeatureTask<LearnerType>::execute() throw()
  {
    double gain;
    double no_delta;
    double yes_delta;
  ...
  */
  ...
  TreeNodeDescr::sub_tree(
    double min_avg,
    unsigned long min_node_cover) const throw()
  {
  ...
  */
  ...
  template<typename LabelType, typename GainType>
  TreeLearner<LabelType, GainType>::Context::~Context() throw()
  {}
  ...
  template<typename LabelType, typename GainType>
  TreeLearner<LabelType, GainType>::LearnContext::~LearnContext() throw()
  {}
