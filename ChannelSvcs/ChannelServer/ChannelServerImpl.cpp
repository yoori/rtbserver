...
namespace ChannelSvcs
{
  ...
  ChannelServerCustomImpl::~ChannelServerCustomImpl() throw()
  {
  }

  void ChannelServerCustomImpl::init_logger_(
    const ChannelServerConfig* config) throw()
  {
    try
    {
  ...
  void ChannelServerCustomImpl::schedule_update_task_(
    unsigned long period, UpdateData* update_data) throw ()
  {
    try
    {
  ...
  void ChannelServerCustomImpl::log_update_() throw()
  {
  ...
  bool ChannelServerCustomImpl::change_source_of_data_() throw()
  {
  ...
  void ChannelServerCustomImpl::get_stats(ChannelServerStats& stats) throw()
  {
  ...
  void ChannelServerCustomImpl::UpdateTask::execute() throw()
  {
  ...
  void ChannelServerCustomImpl::CCGKeywordPacker::operator()(
    const ChannelServerCustomImpl::CCGKeywordPacker::argument_type& id) throw()
  {
    if(neg_out_ &&
