...
namespace ChannelSvcs
{
  namespace
  {
    std::string get_lang_str(unsigned short lang) throw()
    {
      std::string res;
      res.reserve(2);
    ...
    unsigned short get_lang_from_str(const std::string& lang) throw()
    {
      if(lang.size() <  2)
      {
        return 0;
  ...
  void UpdateContainer::cleanup_() throw()
  {
    new_channels_.clear();
  ...
  ChannelIdToMatchInfo_var UpdateContainer::get_old_info() throw ()
  {
