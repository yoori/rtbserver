...
namespace ChannelSvcs
{
   ...
   *
   * */
  ChannelContainerBase::ChannelContainerBase() throw()
  {
  }
  ...
  void ChannelContainer::clean_failed_merge_() throw()
  {
    ChannelChunkArray_var match_chunks;
    {
      ReadGuard_ lock(lock_configuration_);
  ...
  void ChannelContainer::set_ccg(CCGMap* map) throw()
  {
    WriteGuard_ lock(lock_update_data_);
  ...
  ProgressCounter::ProgressCounter(size_t stages, size_t total) throw()
    : progress_(stages),
  ...
  size_t ProgressCounter::get_progress() throw ()
  {
  ...
  size_t ProgressCounter::get_total() throw ()
  {
    return total_;
  }

  size_t ProgressCounter::get_stage() throw ()
  {
    ReadGuard_ guard(lock_progress_);
    return stage_;
  }

  void ProgressCounter::set_progess(size_t inc) throw()
  {
  ...
  void ProgressCounter::change_stage_(size_t stage) throw()
  {
    if (relative_div_)
    {
  ...
  void ProgressCounter::change_stage(size_t stage) throw()
  {
    WriteGuard_ guard(lock_progress_);
    change_stage_(stage);
  }

  size_t ProgressCounter::get_sum_progress() throw()
  {
    ReadGuard_ guard(lock_progress_);
    size_t res = 0;
  ...
  void ProgressCounter::reset(size_t stages, size_t total) throw()
  {
    WriteGuard_ guard(lock_progress_);
