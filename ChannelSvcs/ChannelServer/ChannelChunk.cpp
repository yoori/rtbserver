...
namespace ChannelSvcs
{
  ...
  void dump_map(std::ostream& ostr, const TriggerMap& map) throw()
  {
  ...
  ChannelChunk::~ChannelChunk() throw()
  {
  }
  ...
  * if functor pred isn't true */
  ...
  struct RemovePred
  {
    RemovePred(const RemovedType& removed) throw()
      : removed_(removed)
    {};
  ...
  {
    RemoveSortedPred(const RemovedType& removed) throw()
      : first_(true),
        removed_(removed)
    {};
  ...
  void ChannelChunk::cancel_update() throw()
  {
