...
namespace ChannelSvcs
{
  ...
  public:
    ...
    UpdateData(UpdateContainer* cont) throw();
    ...
    {//holder of unmerged data
      UnmergedData() throw() : index_(0), data_(nullptr) {};
  ...
  public:
    ...
    {
      bool operator<(const unsigned long comp) const throw();
    ...
    Generics::Time get_first_load_stamp() throw();

    const std::vector<unsigned int>& get_sources(unsigned int& count) throw ();

    unsigned long get_check_sum() throw();

    int get_source_id() throw();

  protected:
    virtual ~ChannelServerVariantBase() throw(){};

    void set_sources_id_(int source_id) throw();

    void set_first_load_stamp_(const Generics::Time& stamp) throw();
  ...
  protected:
    ...
    bool is_my_id_(unsigned long id) throw();
  ...
  public:
    ...
    virtual bool get_db_state() throw();

  protected:
    virtual ~ChannelServerDB() throw();
  ...
  private:
    ...
    void save_channel_size_(unsigned long channel_size) throw();
  ...
  protected:
    ...
    virtual ~ChannelServerProxy() throw();
  public:
...
namespace AdServer
{
  ...
  {
    inline
    bool UpdateData::empty() const throw()
    {
      return check_data.empty() && uid_check_data.empty();
    }

    inline
    size_t UpdateData::size() const throw()
    {
    ...
    bool ChannelServerVariantBase::TriggerCheckInfo::operator< (
      const unsigned long comp) const throw()
    {
      return (id < comp);
    }
    ...
    inline
    bool ChannelServerVariantBase::is_my_id_(unsigned long id) throw()
    {
      return (id &&
    ...
    inline
    unsigned long ChannelServerVariantBase::get_check_sum() throw()
    {
      return check_sum_;
    }

    inline
    int ChannelServerVariantBase::get_source_id() throw()
    {
    ...
    inline
    void ChannelServerVariantBase::set_sources_id_(int source_id) throw()
    {
    ...
    inline
    Generics::Time ChannelServerVariantBase::get_first_load_stamp() throw()
    {
      WriteGuard_ lock(mutex_);
