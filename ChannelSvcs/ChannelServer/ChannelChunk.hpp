...
namespace ChannelSvcs
{
  ...
  {
    MatchingEntity() throw()
      : matcher(SoftMatcher_var())
    {}

    MatchingEntity(SoftMatcher* data) throw()
      : matcher(ReferenceCounting::add_ref(data))
    {}

    void swap(MatchingEntity& entity) throw()
    {
  ...
  public:
    ...
    bool operator==(const CCGKeyword& cp) const throw()
    {
  ...
  struct Channel
  {
    ...
    Channel(ChannelIdType id_ = 0) throw();

    bool operator!=(ChannelIdType) const;

    ChannelIdType get_id() const throw();
    void mark_type(unsigned int type) throw();
    void set_status(char status) throw();
    void set_weight(MatchType type, unsigned int weight) throw();
    bool match(unsigned int type) const throw();
    unsigned int match_mask(unsigned int mask) const throw();
  ...
  struct TriggerMatchItem
  {
    ...
    TriggerMatchItem() throw () : flags(0), weight(0){};
  ...
  public:
    ...
    unsigned int get_raiting(const String::SubString& word) const throw ();
    ...
    ChannelMatchInfo* get_info_ptr() throw();
    ...
    static unsigned int get_active_options(unsigned int flags) throw();
...
namespace ChannelSvcs
{
  ...
  inline
  ChannelMatchInfo* ChannelChunk::get_info_ptr() throw()
  {
  ...
  inline
  unsigned int
  ChannelChunk::get_active_options(unsigned int flags) throw()
  {
  ...
  inline
  void ChannelChunk::terminate() throw()
  {
    terminated_ = true;
  }
  ...
  inline
  Channel::Channel(ChannelIdType id_) throw()
    : id(id_),
      flags_(0)
  {
  ...
  inline
  Channel::ChannelIdType Channel::get_id() const throw()
  {
    return id;
  }
  ...
  inline
  bool Channel::match(unsigned int type) const throw()
  {
    return ((flags_ & (1<<type)) != 0);
  }

  inline
  unsigned int Channel::match_mask(unsigned int mask) const throw()
  {
    return (flags_ & mask);
  }

  inline
  void Channel::mark_type(unsigned int type) throw()
  {
    flags_ |= (1<<type);
  }

  inline
  void Channel::set_status(char status) throw()
  {
    size_t index_type;
    switch(status)
    {
  ...
  inline
  void Channel::set_weight(MatchType type, unsigned int weight) throw()
  {
    weight_[type] = weight;
    flags_ |= CH_WEIGHT;
  }
  ...
  inline
  ChannelMatchInfo::ChannelMatchInfo(const ChannelIdToMatchInfo& info) throw()
  {
