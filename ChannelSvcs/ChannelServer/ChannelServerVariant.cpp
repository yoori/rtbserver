...
namespace ChannelSvcs
{
  ...
  ChannelServerDB::~ChannelServerDB() throw()
  {
    try
    {
  ...
  {
    FillChannelIdAdapter(std::vector<unsigned int>& out) throw() : out_(out){};
    void operator()(
  ...
  void ChannelServerDB::save_channel_size_(unsigned long channel_size) throw()
  {
  ...
  bool ChannelServerDB::get_db_state() throw()
  {
 ...
 */
  ...
  ChannelServerProxy::~ChannelServerProxy() throw()
  {}
  ...
  void UpdateData::end_iteration() throw()
  {
