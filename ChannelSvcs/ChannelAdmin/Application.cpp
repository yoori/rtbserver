...
void Application::print_ccg_query_params_() throw()
{
...
Application::StatMarker::StatMarker(
  const std::string& option, const char* name, unsigned long times) throw()
  : option_(STAT_NO),
    times_(times)
{
...
Application::StatMarker::~StatMarker() throw()
{
  if(collection_)
  {
