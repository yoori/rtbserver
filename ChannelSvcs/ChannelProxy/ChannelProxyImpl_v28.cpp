...
namespace ChannelSvcs
{
  ...
  ChannelProxyImpl_v28::ChannelProxyImpl_v28(ChannelProxyImpl* impl) throw()
    : impl_(ReferenceCounting::add_ref(impl))
  {
  }

  ChannelProxyImpl_v28::~ChannelProxyImpl_v28() throw()
  {
  }
  ...
  //
  ::CORBA::ULong ChannelProxyImpl_v28::get_count_chunks() throw(
      AdServer::ChannelSvcs::ImplementationException)
  {
    try
    {
