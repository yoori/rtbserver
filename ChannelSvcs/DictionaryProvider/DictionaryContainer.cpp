...
namespace AdServer
{
  ...
  namespace ChannelSvcs
  {
    ...
    bool
    index_compare(char const* const a, char const* const b) throw ()
    {
      return ::strcmp(a, b) < 0;
    }
    ...
    size_t
    Dictionary::get_words_count() const throw ()
    {
      return word_indexes_.size();
    }

    size_t
    Dictionary::get_lexems_count() const throw ()
    {
      return lexems_count_;
    }

    size_t
    Dictionary::get_buffer_size() const throw ()
    {
      return buffer_.size();
    }
