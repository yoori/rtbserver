...
namespace ChannelSvcs
{
  ...
  ParseTracer::ParseTracer(bool active) throw()
    : active_(active)
  {
  }

  void ParseTracer::start() throw()
  {
    if(active_)
    {
      timer_.start();
  ...
  {
  public:
    bool is_quoted(const String::SubString&) throw ()
    {
      return false;
    }
    const String::SubString& get_part(const String::SubString& part) throw()
    {
      return part;
    }
  };
