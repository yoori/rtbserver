...
namespace AdServer
{
  namespace ChannelSvcs
  {
    ...
    {
    public:
      bool is_quoted(const Part& part) throw ()
      {
        return part.quotes;
      }
      const String::SubString& get_part(const Part& part) throw()
      {
        return part.part;
      }
    };
    ...
    public:
      ...
      static size_t get_reserve_size(const void* data) throw ();
      ...
      static bool exact(const void* trigger) throw();

      static bool negative(const void* trigger) throw();

      static bool quoted(const void* trigger, size_t index) throw();

      static char trigger_type(const void* trigger) throw();
...
namespace AdServer
{
  ...
  {
    inline
    void Serialization::add_bit_(unsigned char& bitvalue, bool value, unsigned char* &result) throw()
    {
    ...
    bool Serialization::get_bit_(
      size_t& position,
      unsigned char& bitvalue,
      const unsigned char* result) throw()
    {
      if(bitvalue == NEXT_BYTE_FLAG)
      {
        ++position;
    ...
    inline
    size_t Serialization::get_reserve_size(const void* data) throw ()
    {
    ...
    inline
    bool Serialization::exact(const void* trigger) throw()
    {
    ...
    inline
    bool Serialization::negative(const void* trigger) throw()
    {
      const unsigned char* trigger_flags =
        static_cast<const unsigned char*>(trigger);
    ...
    inline
    char Serialization::trigger_type(const void* trigger) throw()
    {
      const unsigned char* trigger_flags =
        static_cast<const unsigned char*>(trigger);
