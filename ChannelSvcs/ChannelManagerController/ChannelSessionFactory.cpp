...
void TimedQueryStat::check() throw()
{
...
void TimedQueryStat::dump() throw()
{
  try
  {
...
bool TimedQueryStat::need_dump_() throw()
{
...
namespace ChannelSvcs
{
  ...
  TimedQueryStat::StatisticTask::StatisticTask(
    TimedQueryStat* callback) throw()
    : callback_(callback)
  {
  }

  void TimedQueryStat::StatisticTask::execute() throw()
  {
    callback_->dump();
  }
...
ChannelServerSessionFactoryImpl::ChannelServerSessionFactoryImpl(
    ...
    unsigned long check_period) throw()
...
namespace ChannelSvcs
{
  ...
  ChannelServerSessionImpl::~ChannelServerSessionImpl() throw()
  {
  }
  ...
  void ChannelServerSessionImpl::init_stat_() throw()
  {
  ...
  //
  void ChannelServerSessionImpl::match(
      ...
      ChannelSvcs::ChannelServer>
  {
    ...
    bool operator() (const ChannelServerBase::CCGKeyword& kw) throw();
  ...
  bool GetCCGTraits::operator()(const ChannelServerBase::CCGKeyword& kw) throw()
  {
  ...
  ChannelServerBase::CCGKeywordSeq* ChannelServerSessionImpl::get_ccg_traits(
    const ::AdServer::ChannelSvcs::ChannelIdSeq& ids)
    throw(AdServer::ChannelSvcs::ImplementationException,
          AdServer::ChannelSvcs::NotConfigured)
  {
  ...
  void ChannelServerSessionImpl::report_error(
      ...
      const char* description, const char* error_code) throw()
  {
    if(callback_)
    {
      Stream::Error ostr;
