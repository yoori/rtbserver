...
namespace ChannelSvcs
{
  ...
  public:
    ...
    virtual void check() throw() {};

    virtual void dump() throw() {};
  ...
  private:
    ...
    {
    public:
      StatisticTask(TimedQueryStat* callback) throw();
      ~StatisticTask() throw(){};
...
public:
  ...
  virtual ~ChannelServerSessionFactoryImpl() throw();
...
namespace ChannelSvcs
{
  ...
  public:
    ...
    virtual ~ChannelServerSessionImpl() throw();
  ...
  private:
    ...
    public:
      ...
      {
        template <typename T>
        T resolve(CORBA::ULong ref) throw ();
      };
    ...
    public:
      ...
      bool empty() const throw() { return sort_index_.empty(); }
