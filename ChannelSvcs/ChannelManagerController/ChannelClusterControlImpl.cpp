...
ChannelClusterSessionFactoryImpl::ChannelClusterSessionFactoryImpl(
  Generics::ActiveObjectCallback* callback) throw() :
...
namespace ChannelSvcs
{
  ...
  ChannelClusterSessionImpl::ChannelClusterSessionImpl(
    const AdServer::ChannelSvcs::ProcessControlDescriptionSeq& descr) throw():
  ...
  ChannelClusterSessionImpl::is_alive() throw()
  {
    CORBA::ULong i = 0;
    try
    {
  ...
  void ChannelClusterSessionImpl::shutdown(CORBA::Boolean wait) throw()
  {
    const AdServer::ChannelSvcs::ProcessControlDescriptionSeq& servers_ref =
      servers();
