...
namespace AdServer
{
  ...
  void Application::write_result_(std::ostream& os) throw()
  {
  ...
  int Application::compary_triggers_(
    ...
    const Language::Trigger::Trigger& trigger_view2) throw()
  {
  ...
  void Application::usage_(const char* program_name) throw()
  {
