...
namespace AutoTest
{
  ...
  public:
     ...
     */
    std::string& request_data() throw();

    /**
     * @brief Get response data.
     * @return response data string.
     */
    std::string& response_data() throw();
     ...
     */
    unsigned int status() const throw();
  ...
  inline
  unsigned int
  ClientRequest::status() const throw()
  {
    return status_;
  }
  ...
  inline
  std::string&
  ClientRequest::request_data() throw()
  {
  ...
  inline
  std::string&
  ClientRequest::response_data() throw()
  {
  ...
  inline
  const Generics::Time&
  ClientRequest::start_time() const throw()
  {
    return start_time_;
  }
  ...
  inline
  const Generics::Time&
  ClientRequest::finish_time() const throw()
  {
    return finish_time_;
  }
  ...
  inline
  HTTP::HeaderList&
  ClientRequest::request_headers() throw()
  {
  ...
  inline
  HTTP::HeaderList&
  ClientRequest::response_headers() throw()
  {
