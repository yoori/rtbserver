...
namespace AutoTest
{
  ...
  template<typename TimeType>
  TimeParamBase<TimeType>::~TimeParamBase() throw()
  { }
  ...
  template <class Request, class Base>
  RequestParam<Request, Base>::~RequestParam() throw()
  { }
  ...
  template <class Request, class Base>
  HeaderParam<Request, Base>::~HeaderParam() throw()
  { }
  ...
  template<typename Request, typename TKey, typename TValue, typename Generator>
  ComplexParam<Request, TKey, TValue, Generator>::~ComplexParam() throw()
  { }
  ...
  template <typename Request, typename Param>
  RequestMember<Request, Param>::~RequestMember() throw()
  { }
  ...
  template <typename Request>
  RequestParamSetter<Request>::~RequestParamSetter() throw()
  {
    if (param_)
    {
      delete param_;
