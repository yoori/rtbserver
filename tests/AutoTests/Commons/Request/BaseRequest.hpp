...
namespace AutoTest
{
  ...
  public:
     ...
     * @param time
     */
    Time(const Generics::Time& t) throw ();
  ...
  public:
     ...
     */
    virtual ~BaseParamsContainer() throw();
  ...
  public:
     ...
     */
    virtual ~RequestMemberBase() throw();
  ...
  private:
    void
    operator =(RequestParamSetter&) throw ();

    template <typename Param>
    void
    operator =(Param Request::* member) throw ();
  };
}//namespace AutoTest
