...
namespace AutoTest
{
  ...
  BaseParamsContainer::~BaseParamsContainer() throw()
  { }
  ...
  // RequestMemberBase
  RequestMemberBase::~RequestMemberBase() throw()
  { }
