...
namespace AutoTest
{
  ...
  public:
     ...
     * @brief Destructor.
     */
    virtual ~DebugInfoChecker() throw();
  ...
  public:
     ...
     * @brief Destructor.
     */
    virtual ~SelectedCreativesChecker() throw();
  ...
  public:
     ...
     * @brief Destructor.
     */
    virtual ~ChannelSequenceChecker() throw();
  ...
  public:
     ...
     * @brief Destructor.
     */
    virtual ~SpecialEffectsChecker() throw();
