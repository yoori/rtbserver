...
namespace AutoTest
{
  ...
  public:
     ...
     */
    Cookie::UnitCookieList& get_cookies() throw();

    const Cookie::UnitCookieList& get_cookies() const throw();

    /**
     * @brief Get response headers.
     * @return response headers list.
     */
    HTTP::HeaderList& get_response_headers() throw();

    /**
     * @brief Get request headers.
     * @return request header list.
     */
    HTTP::HeaderList& get_request_headers() throw();

    /**
     * @brief Get response data (http message body).
     * @return received from server message body.
     */
    const std::string& req_response_data() const throw();

    /**
     * @brief Get response status code.
     * @return status code of the last request.
     */
    unsigned int req_status() const throw();

    /**
     * @brief Get request duration.
     * @return duration of the last request.
     */
    const Generics::Time req_time() const throw();
  ...
  inline
  HTTP::HeaderList&
  BaseAdClient::get_response_headers() throw()
  {
  ...
  inline
  HTTP::HeaderList&
  BaseAdClient::get_request_headers() throw()
  {
