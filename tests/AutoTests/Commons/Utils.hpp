...
namespace AutoTest
{
  ...
  public:
     ...
     * @brief Destructor.
     */    
    virtual ~ComparableString() throw ()
    { }
  ...
  public:
    ...
    virtual ~ComparableRegExp() throw () {}
  ...
  public:
    ...
    virtual ~precisely_number() throw () {}
  ...
  public:
    ...
    // conversions
    operator ValueInterface*() const throw ()
    { return var_.in();}
    // accessors
    ...
    ValueInterface& operator *() const
    { return *var_.in();}
    ValueInterface* in() const throw ()
    { return var_.in();}
    ValueInterface* retn() throw ()
    { return var_.retn();}
  };
