...
namespace
{
  ...
  public:
    ...
    EmptyResponse(HttpMethod method, const char* request) throw ();

    ~EmptyResponse() throw ();

    virtual HttpMethod method() const throw ();
...
EmptyResponse::EmptyResponse(
  HttpMethod method,
  const char* request) throw () :
  method_(method),
  request_(request)
{ }

EmptyResponse::~EmptyResponse() throw ()
{ }

HttpMethod
EmptyResponse::method() const throw ()
{
  return method_;
}

const char*
EmptyResponse::http_request() const throw ()
{
  return  request_;
}

const HeaderList&
EmptyResponse::headers() const throw ()
{
  return headers_;
}

int
EmptyResponse::response_code() const throw ()
{
  return 0;
}

const HeaderList&
EmptyResponse::response_headers() const throw ()
{
  return headers_;
}

String::SubString
EmptyResponse::body() const throw ()
{
...
BaseRequest::~BaseRequest() throw()
{}


void
BaseRequest::on_response(
  const ResponseInformation& data) throw ()
{
  if (!request_handled_)
  {
...
ParamsRequest::~ParamsRequest() throw()
{}
...
NSLookupRequest::~NSLookupRequest() throw()
{ }
...
ClickRequest::~ClickRequest() throw()
{ }
...
ActionRequest::~ActionRequest() throw()
{ }
...
PassbackRequest::~PassbackRequest() throw()
{ }
...
UserBindRequest::~UserBindRequest() throw()
{ }
...
OpenRTBRequest::~OpenRTBRequest() throw()
{ }
