...
namespace AdServer
{
  namespace Testing
  {
    ...
    ChannelContainerTest::ChannelContainerTest() throw()
      : cases_(TC_NONE),
        count_chunks_(32),
        count_triggers_(30),
        count_channels_(100),
    ...
    int ChannelContainerTest::check_constructor_() throw()
    {
    ...
    int ChannelContainerTest::check_add_trigger_() throw()
    {
    ...
    int ChannelContainerTest::check_merge_() throw()
    {
    ...
    int ChannelContainerTest::check_match_() throw()
    {
    ...
    int ChannelContainerTest::check_update_() throw()
    ...
    int ChannelContainerTest::check_uids_() throw ()
    {
      UidsData data;
    ...
    int ChannelContainerTest::run(int argc, char* argv[]) throw()
    {
    ...
    void ChannelContainerTest::usage_() throw()
    {
    ...
    void ChannelContainerTest::log_parameters_() throw()
    {
      size_t count = 0;
    ...
    void ChannelContainerTest::parse_tests_(const char* tests) throw()
    {
    ...
    void ChannelContainerTest::parse_argc_(int argc, char* argv[]) throw()
    {
