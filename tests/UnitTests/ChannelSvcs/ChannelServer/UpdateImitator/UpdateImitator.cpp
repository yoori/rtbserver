...
namespace AdServer
{
  namespace UnitTests
  {
    ...
    {
    public:
      bool is_quoted(const std::string&) throw ()
      {
        return false;
      }
      String::SubString get_part(const std::string& part) throw()
      {
        return part;
      }
    };

    void UpdateImitator::generate_triggers_() throw()
    {
    ...
    UpdateImitator::~UpdateImitator() throw()
    {
    }
