...
namespace AdServer
{
  namespace UnitTests
  {
    ...
    MatchPerformanceLargeTest::MatchPerformanceLargeTest() throw()
    {
      time_ = -1;
    }
    ...
    int MatchPerformanceLargeTest::run(int argc, char* argv[]) throw()
    {
    ...
    int MatchPerformanceLargeTest::help() throw()
    {
