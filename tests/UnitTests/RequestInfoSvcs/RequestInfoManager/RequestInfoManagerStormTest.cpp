...
namespace
{
    ...
    public virtual ReferenceCounting::AtomicImpl
  {
    ...
    virtual void
    process_action(const RequestInfo& /*ri*/) throw()
    ...
    virtual void
    process_reach(const ReachInfo& /*reach_info*/) throw() {}
  ...
  template<typename FunctorType>
  void
  MTRunner<FunctorType>::Job::work() throw()
  {
  ...
  template<typename FunctorType>
  void
  MTRunner<FunctorType>::Job::terminate() throw()
  {}
}
