...
//    std::cout << std::endl;
  ...
  std::size_t
  requests() const throw ()
  {
    return processed_requests_;
  }

  std::size_t
  adv_actions() const throw ()
  {
    return processed_adv_actions_;
  }

  std::size_t
  custom_actions() const throw ()
  {
...
{
public:
  ActionPrinter(ProcessHook* hook = 0) throw ()
    : processed_requests_(0),
...
//    std::cout << std::endl;
  ...
  std::size_t requests() const throw ()
  {
    return processed_requests_;
  }

  std::size_t actions() const throw ()
  {
    return processed_actions_;
  }

  std::size_t custom_actions() const throw ()
  {
    return processed_custom_actions_;
  }
...
//      << impression_time  << std::endl;
  ...
  std::size_t
  passbacks() const throw ()
  {
    return passbacks_count_;
  }

  std::size_t
  imp_passbacks() const throw ()
  {
...
public:
  ...
  std::size_t operations() const throw ()
  {
    return op_count_;
  }
...
struct Tester
{
  Tester(std::size_t threads = 5) throw ()
...
struct AllFilesGood : public ProcessHook
{
  ...
  void
  check(const std::ostringstream& ostr) const throw ()
  {
    if (!ostr.str().empty())
    {
  ...
  check(
    ...
    std::size_t passback_processor_imp_passbacks) const throw ()
  {
    struct TestCase
    {
      const char* NAME;
...
{
  FilesGoodAndBad(Tester& t) throw()
    : AllFilesGood(t)
  {}

  virtual
  ~FilesGoodAndBad() throw ()
  {}
...
struct InterruptFileProcess : public ProcessHook
{
  ...
  InterruptFileProcess(Tester& t) throw()
    : tester(t)
  {}

  virtual
  ~InterruptFileProcess() throw ()
  {}
...
struct ProcessedRowNumberInErrorFileName : public ProcessHook
{
  ...
  ProcessedRowNumberInErrorFileName(Tester& t) throw()
    : tester(t)
  {}

  virtual
  ~ProcessedRowNumberInErrorFileName() throw ()
  {}
  ...
  void
  generate(const char* type) const throw ()
  {
