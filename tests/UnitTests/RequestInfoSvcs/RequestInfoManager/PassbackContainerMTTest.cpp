...
public:
   ...
   */
  MTPassbackProcessTester(const TestIt* test_it) throw ()
    : test_it_(test_it)
  {
  ...
  {
  public:
    Task(const RequestId& id, unsigned long tag_id, const TestIt* test_it) throw ()
      : test_it_(test_it)
    {
  ...
  {
    Request(const RequestId& id, unsigned long tag_id, const TestIt* test_it) throw ()
  ...
  {
    Process(const RequestId& id, unsigned long tag_id, const TestIt* test_it) throw ()
      : Task(id, tag_id, test_it)
    {}
