...
protected:
  virtual
  ~CollTriggerActionProcessor() throw () = default;
...
protected:
  virtual
  ~UserTriggerMatchProfileProviderTestImpl() throw () = default;
...
public:
  ...
  int run(const char* root_path) throw ()
  {
    try
    {
...
protected:
  virtual
  ~OneSearchMatchTest() throw () = default;
};
...
protected:
  virtual
  ~FewTriggersMatchTest() throw () = default;
};
...
protected:
  virtual
  ~ZeroMinVisitsMatchTest() throw () = default;
};
...
protected:
  virtual
  ~ZeroMinVisitsImpressionTest() throw () = default;
};
...
protected:
  virtual
  ~PastMatchAfterImpressionTest() throw () = default;
};
...
protected:
  virtual
  ~PastMatchAfterMatchAndImpressionTest() throw () = default;
};
...
protected:
  virtual
  ~PastImpressionAfterClickTest() throw () = default;
};
...
protected:
  virtual
  ~TimeToExpireTest() throw () = default;
};
...
protected:
  virtual
  ~ImpressionDivideTest() throw () = default;
};
...
protected:
  virtual
  ~OneTriggerInChannelMatchTest() throw () = default;
};
...
protected:
  virtual
  ~OneTriggerInChannelMatchUnexistingTest() throw () = default;
};
...
protected:
  virtual
  ~SmallChannelMatchTest() throw () = default;
};
...
protected:
  virtual
  ~LastTriggerDeactivatedMatchTest() throw () = default;
};
...
protected:
  virtual
  ~ChannelDeactivatedMatchTest() throw () = default;
};
...
protected:
  virtual
  ~FewKeywordsOneUrlChannelMatchTest() throw () = default;
};
...
protected:
  virtual
  ~MergeChannelMatchTest() throw () = default;
};
...
protected:
  virtual
  ~MergeFewChannelsMatchTest() throw () = default;
};
...
protected:
  virtual
  ~DivideImpModelTest() throw () = default;
};
...
protected:
  virtual
  ~FewTriggersImpModelTest() throw () = default;
};
...
protected:
  virtual
  ~DeactivatedTriggerImpModelTest() throw () = default;
};
