...
protected:
  virtual
  ~NullInvProcessor() throw () = default;
};
...
protected:
  virtual
  ~CollInvTestProcessor() throw () = default;
...
public:
  ...
  base_match_info(const Generics::Time& date) throw()
  {
  ...
  static
  MatchRequestProcessor::MatchInfo
  simple_match_info(const Generics::Time& date) throw()
  {
  ...
  static
  MatchRequestProcessor::MatchInfo
  simple_match_info(const char* date) throw()
  {
  ...
  simple_etalon(
    ...
    const char* country_code = "RU") throw()
  {
  ...
  InventoryActionProcessor::InventoryInfo
  simple_etalon(
    const char* date, const char* country_code = "RU") throw()
  {
...
protected:
  virtual
  ~TestChannelByCPM() throw () = default;
};
...
protected:
  virtual
  ~TestSimpleDailyProcessing() throw () = default;
};
...
protected:
  virtual
  ~TestExtendedDailyProcessing() throw () = default;
};
