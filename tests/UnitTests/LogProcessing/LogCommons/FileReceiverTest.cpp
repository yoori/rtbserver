...
bool
OverridedFileReceiver::access_(const char* name) throw ()
{
...
FileReceiver_var
make_receiver(
  size_t max_files_to_store) throw ()
{
#ifdef EMULATE_FILES
...
{
public:
  FetchFilesTask(FileReceiver_var file_receiver) throw ();

  virtual
  ~FetchFilesTask() throw ();
...
FetchFilesTask::FetchFilesTask(FileReceiver_var file_receiver) throw ()
  : file_receiver_(file_receiver)
{}

FetchFilesTask::~FetchFilesTask() throw ()
{}
...
{
public:
  ReleaseFileTask(FileReceiver::FileGuard_var file_guard) throw ();

  virtual
  ~ReleaseFileTask() throw ();
...
ReleaseFileTask::ReleaseFileTask(FileReceiver::FileGuard_var file_guard) throw ()
  : file_guard_(file_guard)
{}

ReleaseFileTask::~ReleaseFileTask() throw ()
{}
...
void
read_file_hook(const std::string& file_name) throw ()
{
