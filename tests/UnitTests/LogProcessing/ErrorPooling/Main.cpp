...
{
public:
  ErrorGenerator(ErrorPool& errors) throw ();
...
{
public:
  LogGenerator(ErrorPool& errors) throw ();
...
{
public:
  CellsErrorGenerator(ErrorPool& errors) throw ();
...
ErrorGenerator::ErrorGenerator(ErrorPool& errors) throw ()
  : errors_(errors)
{
}

void
ErrorGenerator::operator ()() throw ()
{
...
LogGenerator::LogGenerator(ErrorPool& errors) throw ()
  : errors_(errors)
{
}

void
LogGenerator::operator ()() throw ()
{
  Stream::Error ostr;
...
CellsErrorGenerator::CellsErrorGenerator(ErrorPool& errors) throw ()
  : errors_(errors),
    count_(0)
{
}
...
void
CellsErrorGenerator::operator ()() throw ()
{
...
void
frontend_group_logger_test() throw ()
{
