...
bool
operator< (const TestCase& test1, const TestCase& test2) throw ();
...
TestFactory::available_tests() const throw ()
{
...
{
public:
  TestFailed(const std::string& msg) throw ();
};

TestFailed::TestFailed(const std::string& msg) throw ()
