...
StatSource::Stat::CCGStat zero_ccg_stat() throw()
{
...
protected:
  virtual ~TestModifyConfigSource() throw()
  {}
};
...
//#define PRINT_STATS
  ...
  void add(const Generics::Time& ts, Stat* stat) throw()
  {
