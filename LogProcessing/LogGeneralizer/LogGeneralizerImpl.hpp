...
private:
  ...
  static void
  disable_upload_() throw ();

  template <typename LogTraits>
  static void
  enable_upload_() throw ();
  ...
  {
  public:
    CheckLogsCondition(LogGeneralizerImpl* log_generalizer) throw ()
  ...
  {
  public:
    CheckLogsAlways(LogGeneralizerImpl*) throw ()
    {}
  ...
  void
  check_logs(const LogProcThreadInfo_var& context) throw ();
  ...
  void clear_expired_hits_data() throw();

  void schedule_clear_expired_msg() throw();
