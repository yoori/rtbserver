...
namespace LogProcessing
{
  ...
  private:
      ...
      const BaseTraits::CollectorType::DataT::KeyT &key)
    {
      ...
      std::string action_referrer_url = key.action_referrer_url();
      write_string_as_csv(os, trim(action_referrer_url, 2000)) << ',';
  ...
  private:
      ...
      const BaseTraits::CollectorType::DataT::DataT &data)
    {
      ...
      std::string referrer = data.referrer();
      write_string_as_csv(os, trim(referrer, 2000), "-") << ',';
