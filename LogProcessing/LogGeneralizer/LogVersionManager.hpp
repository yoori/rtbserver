...
private:
  virtual
  ~CollectorBundleProxyImpl() throw() {}
...
{
public:
  ConversionAdder(LogVersionManager* log_version_manager) throw ()
...
protected:
  ...
  public:
    PreviousVersionAdder(LvmBaseImplType* manager) throw()
    :
