...
namespace LogProcessing
{
  ...
  void
  FeedRouteGroupProcessor::work_() throw ()
  {
  ...
  void
  FeedRouteGroupProcessor::process_file_(const FileEntity& file) throw ()
  {
  ...
  void
  FeedRouteGroupProcessor::try_unlink_files_() throw ()
  {
  ...
  void
  FeedRouteGroupProcessor::fetch_files_(SyncLog::LogType log_type) throw ()
  {
