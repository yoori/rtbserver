...
namespace PlainStorage
{
  ...
  public:
     ...
     */
    virtual ~ReadRecordImpl() throw();

    virtual void lock_read_() throw() { lock_.lock_read(); };

    virtual void unlock_() throw() { lock_.unlock(); };
  ...
  public:
    ...
    virtual void lock_write_() throw() { lock_.lock_write(); };
  ...
  template<typename NextIndexType,
    typename NextIndexSerializerType, typename SyncPolicyType>
  ReadRecordLayer<NextIndexType, NextIndexSerializerType, SyncPolicyType>::
  ReadRecordImpl::~ReadRecordImpl() throw()
  {}
  ...
  bool
  WriteRecordLayer<NextIndexType, NextIndexSerializerType, SyncPolicyType>::
  WriteRecordImpl::remove_ref_no_delete_() const throw()
  {
  ...
  template<typename NextIndexType,
    typename NextIndexSerializerType, typename SyncPolicyType>
  WriteRecordLayer<NextIndexType, NextIndexSerializerType, SyncPolicyType>::
  WriteRecordImpl::~WriteRecordImpl() throw()
  {
    if(TRACE_WRITE_RECORD_BLOCK)
    {
  ...
  const NextIndexType&
  WriteRecordLayer<NextIndexType, NextIndexSerializerType, SyncPolicyType>::
  WriteRecordImpl::block_index() const throw()
  {
    return block_index_;
  }
