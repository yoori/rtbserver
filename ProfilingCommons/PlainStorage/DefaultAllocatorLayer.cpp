...
namespace PlainStorage
{
  ...
  DefaultAllocatorLayer::WriteBlockImpl::~WriteBlockImpl() throw()
  {}
  ...
  DefaultAllocatorLayer::~DefaultAllocatorLayer() throw()
  {
  ...
  void
  DefaultAllocatorLayer::print_(std::ostream& out) throw()
  {
