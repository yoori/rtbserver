...
namespace PlainStorage
{
  ...
  public:
    ...
    virtual ~WriteBlockImpl() throw();

    virtual bool remove_ref_no_delete_() const throw();
    ...
    void print_(std::ostream& out, SizeType byte_count) throw();
  ...
  ReadFileLayer::ReadBlockImpl::~ReadBlockImpl() throw()
  {
  ...
  WriteFileLayer::WriteBlockImpl::~WriteBlockImpl() throw()
  {}

  bool
  WriteFileLayer::WriteBlockImpl::remove_ref_no_delete_() const throw()
  {
  ...
  ReadFileLayer::~ReadFileLayer() throw()
  {
    file_.close();
  }
  ...
  unsigned long
  ReadFileLayer::area_size() const throw()
  {
  ...
  SizeType
  ReadFileLayer::block_data_size() const throw ()
  {
  ...
  WriteFileLayer::~WriteFileLayer() throw()
  {
    file_.close();
  }
  ...
  unsigned long
  WriteFileLayer::area_size() const throw()
  {
    return static_cast<unsigned long>(file_in_blocks_size_) * block_size_;
  }

  SizeType
  WriteFileLayer::block_data_size() const throw ()
  {
    return block_size_ - 2*sizeof(u_int32_t);
  }

  FileBlockIndex
  WriteFileLayer::max_block_index() const throw()
  {
