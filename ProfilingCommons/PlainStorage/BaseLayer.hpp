...
namespace PlainStorage
{
  ...
  struct PropertyValue
  {
    ...
    void
    value(const void* new_val, SizeType new_size) // throw ()
    {
  ...
  protected:
    void
    init_value_(const void* new_val, SizeType new_size) // throw ()
    {
  ...
  struct ReadBaseLayer : public virtual ReferenceCounting::DefaultImpl<>
  {
    ...
    virtual
    unsigned long area_size() const throw() = 0;
  };
  ...
  struct BlockSizeAllocator: public virtual ReferenceCounting::DefaultImpl<>
  {
    ...
    virtual SizeType max_block_size() const throw() = 0;
