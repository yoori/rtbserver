...
namespace PlainStorage
{
  ...
  struct ExIndexSerializer
  {
     ...
     */
    static SizeType max_size() throw()
    {
      return
     ...
     */
    static SizeType size(const ExIndexType& val) throw()
    {
      return
        sizeof(typename ExIndexType::SubIndex) +
  ...
  public:
     ...
     */
    void print_control_block_(std::ostream& out) throw();
  ...
  protected:
    ...
    struct AllocatePool: public ReferenceCounting::AtomicImpl
    {
      ...
      control_blocks_i() const throw()
      {
        return control_blocks_;
      }

      const ControlBlock&
      next_control_block_i() const throw()
      {
        return next_control_block_;
      }

    protected:
      virtual ~AllocatePool() throw() {}
  ...
  protected:
     ...
     */
    virtual ~WriteFragmentLayer() throw();
