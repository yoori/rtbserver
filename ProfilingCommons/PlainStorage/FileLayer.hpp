...
namespace PlainStorage
{
  ...
  public:
     ...
     */
    SizeType block_data_size() const throw ();
     ...
     */
    FileBlockIndex max_block_index() const throw();
  ...
  public:
     ...
     * memory
     */
    virtual FileBlockIndex max_block_index() const throw();
