...
namespace AdServer
{
  namespace ProfilingCommons
  {
    ...
    struct UuidAccessor
    {
      ...
      static unsigned int size(const Generics::Uuid& key) throw();
      ...
      static unsigned int size(const UuidPackHashAdapter& key) throw();
...
namespace AdServer
{
  namespace ProfilingCommons
  {
    ...
    inline
    unsigned int
    UuidAccessor::size(const Generics::Uuid&) throw()
    {
    ...
    inline
    unsigned int
    UuidAccessor::size(const UuidPackHashAdapter&) throw()
    {
      return Generics::Uuid::size();
    }
