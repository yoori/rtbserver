...
namespace ProfilingCommons
{
  ...
  protected:
    ...
    public:
       ...
       * Do not implemented
       */
      const Generics::Time& creation_time() const throw();
