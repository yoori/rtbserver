...
namespace RequestInfoSvcs
{
  ...
  ExpressionMatcherImpl::~ExpressionMatcherImpl() throw()
  {}
  ...
  void ExpressionMatcherImpl::load_data_() throw()
  {
  ...
  bool ExpressionMatcherImpl::resolve_user_info_manager_session_() throw()
  {
//  static const char* FUN = "ExpressionMatcherImpl::resolve_user_info_manager_session_()";
  ...
  void
  ExpressionMatcherImpl::try_start_daily_processing_loop_() throw()
  {
  ...
  void
  ExpressionMatcherImpl::update_expression_channels_() throw()
  {
  ...
  bool
  ExpressionMatcherImpl::check_sampling_(const UserId& user_id) const throw ()
  {
  ...
  void
  ExpressionMatcherImpl::update_stats_() throw()
  {
  ...
  void
  ExpressionMatcherImpl::flush_logs_() throw()
  {
  ...
  void
  ExpressionMatcherImpl::clear_expired_users_(bool reschedule) throw()
  {
  ...
  ExpressionMatcherImpl::daily_check_users_impl_(
    DailyCheckState* initial_state) throw()
  {
