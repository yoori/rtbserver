...
namespace RequestInfoSvcs
{
  ...
  UserTriggerMatchContainer::~UserTriggerMatchContainer() throw()
  {}

  UserTriggerMatchContainer::Config_var
  UserTriggerMatchContainer::config() const throw()
  {
    return config_.get();
  }

  void
  UserTriggerMatchContainer::config(Config* config) throw()
  {
