...
namespace RequestInfoSvcs
{
  ...
  protected:
    virtual
    ~ChannelInventoryLogger() throw () = default;
  ...
  protected:
    virtual
    ~ChannelImpInventoryLogger() throw () = default;
  ...
  protected:
    virtual
    ~ChannelActivityLogger() throw () = default;
  };
  ...
  protected:
    virtual
    ~ChannelPriceRangeLogger() throw () = default;
  ...
  protected:
    virtual
    ~ChannelPerformanceLogger() throw () = default;
  ...
  protected:
    virtual
    ~ChannelTriggerImpLogger() throw () = default;
  ...
  ExpressionMatcherOutLogger::~ExpressionMatcherOutLogger() throw()
  {}
