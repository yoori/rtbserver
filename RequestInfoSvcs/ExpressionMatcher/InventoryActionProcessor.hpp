...
namespace AdServer
{
  namespace RequestInfoSvcs
  {
    ...
    protected:
      virtual
      ~MatchRequestProcessor() throw () = default;
    };
    ...
    public:
      ...
      public:
        ...
        InventoryInfo(const InventoryUserInfo& inv_user_info) throw()
        ...
        struct ChannelImpAppearInfo
        {
          ...
          bool operator==(const ChannelImpAppearInfo& right) const throw();
        ...
        struct ChannelImpInfo
        {
          ...
          bool operator==(const ChannelImpInfo& right) const throw();
      ...
      public:
        void print(std::ostream& ostr, const char* offset) const throw();

        bool operator==(const InventoryInfo& right) const throw();
    ...
    protected:
      virtual
      ~InventoryActionProcessor() throw () = default;
    };
  ...
  namespace RequestInfoSvcs
  {
    namespace
    {
      ...
      bool compare_seq_(
        ...
        const ContainerType& right) throw()
      {
    ...
    ChannelImpInfo::operator==(
      const ChannelImpInfo& right) const throw()
    {
    ...
    bool
    InventoryActionProcessor::InventoryInfo::
    ChannelImpInfo::empty() const throw()
    {
    ...
    ChannelImpAppearInfo::operator==(
      const ChannelImpAppearInfo& right) const throw()
    {
    ...
    bool
    InventoryActionProcessor::InventoryInfo::
    ChannelImpAppearInfo::empty() const throw()
    {
    ...
    InventoryActionProcessor::InventoryInfo::print_channel_counter_map_(
      std::ostream& ostr,
      const ChannelImpCounterVector& chs) const throw()
    {
    ...
    InventoryActionProcessor::InventoryInfo::print_channel_avg_revenue_map_(
      std::ostream& ostr,
      const ChannelAvgRevenueVector& chs) const throw()
    {
      for(auto ch_it = chs.begin(); ch_it != chs.end(); ++ch_it)
      {
    ...
    InventoryActionProcessor::InventoryInfo::print(
      std::ostream& ostr, const char* offset) const throw()
    {
    ...
    InventoryActionProcessor::InventoryInfo::operator==(
      const InventoryInfo& right) const throw()
    {
      return
        time == right.time &&
