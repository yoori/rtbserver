...
namespace RequestInfoSvcs{
  ...
  protected:
    virtual ~UserFraudDeactivator() throw() {}
  ...
  RequestInfoManagerImpl::~RequestInfoManagerImpl() throw()
  {
    try
    {
      deactivate_object();
  ...
  void
  RequestInfoManagerImpl::clear_expired(CORBA::Boolean synch) throw()
  {
    if(synch)
    {
  ...
  void
  RequestInfoManagerImpl::start_logs_processing_() throw()
  {
  ...
  bool
  RequestInfoManagerImpl::load_user_fraud_protection_chunk_files_() throw()
  {
  ...
  bool
  RequestInfoManagerImpl::load_user_action_info_chunk_files_() throw()
  {
  ...
  bool
  RequestInfoManagerImpl::load_user_campaign_reach_chunk_files_() throw()
  {
  ...
  bool
  RequestInfoManagerImpl::load_request_chunk_files_() throw()
  {
  ...
  bool
  RequestInfoManagerImpl::init_passback_container_() throw()
  {
  ...
  bool
  RequestInfoManagerImpl::init_user_site_reach_container_() throw()
  {
  ...
  bool
  RequestInfoManagerImpl::init_user_tag_request_merge_container_() throw()
  {
    static const char* FUN =
      "RequestInfoManagerImpl::init_user_tag_request_merge_container_()";
  ...
  bool
  RequestInfoManagerImpl::init_billing_processor_() throw()
  {
  ...
  void
  RequestInfoManagerImpl::flush_logs_() throw()
  {
  ...
  bool
  RequestInfoManagerImpl::update_fraud_rules_(bool loop_update) throw()
  {
