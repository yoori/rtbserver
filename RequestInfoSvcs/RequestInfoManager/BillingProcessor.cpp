...
namespace RequestInfoSvcs
{
  ...
  protected:
    ...
    public:
      ...
      bool
      operator==(const AggregateRequestHashAdapter& right) const throw();
    ...
    public:
      ...
      bool
      operator==(const SaveAggregateRequestHashAdapter& right) const throw();
    ...
    {
      bool
      operator()(const Request* left, const Request* right) const throw();
    };
    ...
    protected:
      virtual
      ~AmountAggregateHolder() throw() = default;
    };
    ...
    protected:
      virtual
      ~ServerStateHolder() throw() = default;
    };
    ...
    struct ServerStateFirstRequestLess
    {
      ...
      operator()(const ServerStateHolder* left,
        const ServerStateHolder* right) const throw();
    };
  ...
  protected:
    ...
    static ServerArray
    init_servers_(unsigned long server_count) throw();
  ...
  protected:
    ...
    protected:
      ...
      protected:
        virtual ~ActivateServerGoal() throw() = default;
  ...
  size_t
  BillingProcessor::RequestPool::
  AggregateRequestHashAdapter::hash() const throw()
  {
    return hash_;
  }
  ...
  BillingProcessor::RequestPool::
  AggregateRequestHashAdapter::request() const throw()
  {
    return request_;
  }
  ...
  size_t
  BillingProcessor::RequestPool::
  SaveAggregateRequestHashAdapter::hash() const throw()
  {
    return hash_;
  }
  ...
  const BillingProcessor::Request_var&
  BillingProcessor::RequestPool::
  SaveAggregateRequestHashAdapter::request() const throw()
  {
    return request_;
  }
...
#       endif
  ...
  void
  BillingProcessor::RequestPool::print(std::ostream& ostr) throw()
  {
  ...
  void
  BillingProcessor::Sender::Job::ActivateServerGoal::deliver() throw()
  {
  ...
  void
  BillingProcessor::Sender::Job::work() throw()
  {
    while(true)
    {
      unsigned long server_index;
...
#     endif
  ...
  void
  BillingProcessor::Sender::Job::terminate() throw()
  {
  ...
  BillingProcessor::~BillingProcessor() throw()
  {}
  ...
  void
  BillingProcessor::wait_object() throw()
  {
