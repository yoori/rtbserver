  ...
  namespace
  {
    ...
    private:
      ...
      protected:
        ...
        static
        unsigned long
        get_url_hash_(const HTTP::HTTPAddress& url) throw();
...
#         endif
  ...
  void
  RequestPool::print(std::ostream& ostr) const throw()
  {
    ostr <<
