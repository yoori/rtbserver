...
namespace RequestInfoSvcs
{
  ...
  public:
    ...
    virtual void
    process(LogProcessing::FileReceiver::FileGuard* file_ptr) throw ();

  protected:
    virtual
    ~LogRecordFetcherBase() throw ()
    {}
  ...
  LogFetcherBase::LogFetcherBase(
    unsigned int priority,
    LogProcessing::FileReceiver* file_receiver) throw ()
    : priority_(priority), file_receiver_(ReferenceCounting::add_ref(file_receiver))
  {}

  unsigned int
  LogFetcherBase::priority() const throw ()
  {
    return priority_;
  }

  LogProcessing::FileReceiver_var
  LogFetcherBase::file_receiver() throw ()
  {
  ...
  Generics::Time
  LogRecordFetcherBase::check_files() throw ()
  {
  ...
  struct RequestRecordProcessor
  {
    ...
    RequestRecordProcessor(const RequestRecordProcessor& r) throw ()
  ...
  void
  RequestLogLoader::process_file_() throw ()
  {
    static const char* FUN = "LogRecordFetcherBase::process()";
