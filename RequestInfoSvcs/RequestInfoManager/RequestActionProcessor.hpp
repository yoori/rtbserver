  ...
  namespace RequestInfoSvcs
  {
    ...
    struct RequestInfo
    {
      ...
      struct Revenue
      {
        ...
        std::ostream&
        print(std::ostream& out, const char* space) const throw();
      ...
      RequestInfo(const AdServer::Commons::RequestId& req_id =
        AdServer::Commons::RequestId()) throw ();
    ...
    */
    ...
    struct AdvCustomActionInfo
    {
      ...
      std::ostream& print(
        std::ostream& ostr, const char* space = "") const throw();
    };
    ...
    protected:
      virtual ~RequestActionProcessor() throw() {}
    };
    ...
    protected:
      virtual ~RequestContainerProcessor() throw() {}
    };
    ...
    protected:
      virtual ~AdvActionProcessor() throw() {}
    };
    ...
    protected:
      virtual ~UnmergedClickProcessor() throw() {}
    };
...
namespace AdServer
{
  namespace RequestInfoSvcs
  {
    /* RequestInfo */
    inline
    RequestInfo::ChannelRevenue::ChannelRevenue() throw ()
      : channel_id(0),
        channel_rate_id(0),
        impression(0),
        adv_impression(0),
    ...
    RequestInfo::RequestInfo(
      const AdServer::Commons::RequestId& req_id) throw ()
      : request_id(req_id),
        fraud(RS_NORMAL),
        test_request(false),
        walled_garden(false),
