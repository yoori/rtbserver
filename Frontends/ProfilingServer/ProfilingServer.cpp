...
namespace Profiling
{
  ...
  void
  ProfilingServer::ZmqRouter::work_() throw ()
  {
    while(active())
    {
      try
  ...
  void
  ProfilingServer::ZmqWorker::do_work_(const char* inproc_address) throw ()
  {
  ...
  ProfilingServer::is_alive() throw()
  {
