...
namespace Frontends
{
  ...
  protected:
    virtual
    ~VKProtobufDescriptorHandler() throw();
  ...
  int
  VKProtobufDescriptorHandler::fd() const throw()
  {
    return fd_;
  }
  ...
  void
  VKProtobufDescriptorHandler::stopped() throw()
  {}

  void
  VKProtobufDescriptorHandler::add_write_buf_(Buf& buf) throw()
  {
  ...
  void
  UIDGeneratorAdapterImpl::print_stats_() throw()
  {
  ...
  void
  UIDGeneratorAdapterImpl::flush_logs_() throw()
  {
