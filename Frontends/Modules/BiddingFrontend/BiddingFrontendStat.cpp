...
namespace
{
  ...
  struct GapKey
  {
    ...
    bool
    operator <(const Generics::Time& rhs) const throw ()
    {
      return t < rhs;
    }
  };
  ...
  convert_to_key(const Generics::Time& value) throw ()
  {
    const GapKey* gap =
...
namespace AdServer
{
  ...
  StatHolder::StatData&
  StatHolder::StatData::operator +=(const StatHolder::StatData& rhs) throw ()
  {
  ...
  void
  StatHolder::add_timeout(const Generics::Time& timeout) throw ()
  {
