...
{  
  ...
  private:
    ...
    {
    protected:
      virtual ~RequestParamsHolder() throw() = default;
    };
  ...
  private:
    ...
    void
    update_config_() throw ();

    void
    flush_state_() throw ();

    void
    set_ext_config_(ExtConfig* config) throw();

    ExtConfig_var
    get_ext_config_() throw();
    ...
    Generics::Time
    get_request_timeout_(const FCGI::HttpRequest& request) throw ();
  ...
  private:
    ...
    Generics::TaskRunner_var passback_task_runner_;
    ...
    Algs::AtomicInt bid_task_count_;
...
namespace Bidding
{
  ...
  Frontend::get_ext_config_() throw()
  {
