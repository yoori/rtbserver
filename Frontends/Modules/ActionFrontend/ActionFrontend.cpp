...
namespace Action
{
    ...
    FCGI::HttpResponse& response) throw ()
  {
    ...
    try
    {
      ...
      return process_advertiser_request(response, request, request_info, return_html);
    }
    ...
    throw()
  {
    ...
    verify_action_info.country_code << request_info.country;
