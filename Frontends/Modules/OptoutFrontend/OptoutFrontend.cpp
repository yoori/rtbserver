...
namespace AdServer
{
  ...
  bool
  OptoutFrontend::will_handle(const String::SubString& uri) throw ()
  {
  ...
  {
    static const char* FUN = "OptoutFrontend::handle_request()";
    int http_result = 200;
