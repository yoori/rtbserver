...
namespace AdServer
{
  ...
  public:
    ...
    DebugSink(bool allow_show_history_profile) throw ();
  ...
  private:
    ...
    fill_debug_body_(
      HttpResponse& response,
      const String::SubString& error_description) throw ();
...
namespace AdServer
{
  ...
  inline
  void
  DebugInfoStatus::set(DebugInfo new_value) throw ()
  {
