...
namespace AdServer
{
  ...
  AdFrontendStat::BaseStatData::operator +=(const AdFrontendStat::BaseStatData& rhs) throw () {
  ...
  void
  AdFrontendStat::StatData::process_time(const Generics::Time& time, Generics::Time& total, Generics::Time& min, Generics::Time& max) throw ()
  {
    total += time;
    if (time < min)
    {
