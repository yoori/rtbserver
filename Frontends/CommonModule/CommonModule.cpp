...
namespace AdServer
{
  ...
  void CommonModule::update(unsigned service_index) throw()
  {
  ...
  CommonModule::url_matcher() const throw()
  {
  ...
  CommonModule::web_browser_matcher() const throw()
  {
    SyncPolicy::ReadGuard lock(matchers_lock_);
  ...
  CommonModule::platform_matcher() const throw()
  {
    SyncPolicy::ReadGuard lock(matchers_lock_);
  ...
  CommonModule::ip_matcher() const throw()
  {
    return ip_matcher_;
  }

  FrontendCommons::CountryFilter_var
  CommonModule::country_filter() const throw()
  {
    return country_filter_;
  }

  Language::Segmentor::SegmentorInterface_var
  CommonModule::segmentor() const throw()
  {
    return segmentor_;
  }
