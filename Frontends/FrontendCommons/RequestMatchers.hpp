...
namespace FrontendCommons
{
  ...
  private:
    struct MatchElement
    {
      ...
      MatchElement(const MatchElement& init) throw();
    ...
    {
    public:
      OnMatch(unsigned long max_priority) throw ();
      ...
      const MatchElement*
      get_matched_element() const throw ();
  ...
  protected:
    virtual ~WebBrowserMatcher() throw() {}
  ...
  private:
    ...
    public:
      OnMatch(const String::SubString& user_agent,
        unsigned long max_priority) throw ();
...
namespace FrontendCommons
{
  ...
  MatchElement::MatchElement(
    ...
    : platform_id(platform_id_val),
      ...
      marker(marker_val),
      match_regexp(match_regexp_val[0] ? new String::RegEx(String::SubString(match_regexp_val), PCRE_CASELESS) : 0),
      output_regexp(output_regexp_val[0] ? new String::RegEx(String::SubString(output_regexp_val), PCRE_CASELESS) : 0),
