...
namespace FrontendCommons
{
  ...
  */
  ...
  inline
  bool
  is_secure_request(const HttpRequest& request) throw()
  {
  ...
  */
  ...
  inline
  void
  no_cache(HttpResponse& response) throw()
  {
...
namespace FrontendCommons
{
  ...
  inline
  unsigned long
  referer_hash(const String::SubString& s) throw ()
  {
    std::size_t value = 0;
    {
  ...
  inline
  unsigned long
  short_referer_hash(const String::SubString& s) throw ()
  {
    try
    {
