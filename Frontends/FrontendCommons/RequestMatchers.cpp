...
namespace FrontendCommons
{
   ...
   */
  PlatformMatcher::OnMatch::OnMatch(unsigned long max_priority) throw ()
  ...
  PlatformMatcher::OnMatch::get_matched_element() const throw ()
  {
    return matched_element_;
  }

  PlatformMatcher::CategoryMatcher::CategoryMatcher() throw ()
  {
  ...
  WebBrowserMatcher::OnMatch::get_sub_strs() const throw ()
  {
    return sub_strs_;
  }
  ...
  WebBrowserMatcher::WebBrowserMatcher() throw ()
    : max_priority_(std::numeric_limits<unsigned long>::min()),
      matcher_(false)
  {}
  ...
  inline
  size_t
  IPMatcher::CohortMaskHashAdapter::hash() const throw()
  {
    return hash_;
  }
  ...
  // CountryFilter
  CountryFilter::CountryFilter() throw()
  {}
