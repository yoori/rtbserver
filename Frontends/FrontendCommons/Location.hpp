...
namespace FrontendCommons
{
  ...
  struct Location: public ReferenceCounting::DefaultImpl<>
  {
    ...
    parse(const String::SubString& value) throw();
...
namespace FrontendCommons
{
  ...
  inline
  Location_var
  Location::parse(const String::SubString& value) throw()
  {
    std::string country;
    String::SubString::SizeType country_end;
  ...
  inline
  CoordLocation_var
  CoordLocation::parse(const String::SubString& value) throw()
  {
    // 50km
